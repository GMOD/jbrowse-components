...
## circular
cp base/circular/assembly.ts $JB2TMP/jbrowse-react-circular-genome-view/src/
cp base/circular/assembly.ts $JB2TMP/jbrowse-react-circular-genome-view-cra5/src/
cp base/circular/assembly.ts $JB2TMP/jbrowse-react-circular-genome-view-vanillajs/assembly.js
cp base/circular/tracks.ts $JB2TMP/jbrowse-react-circular-genome-view/src/
cp base/circular/tracks.ts $JB2TMP/jbrowse-react-circular-genome-view-cra5/src/
cp base/circular/tracks.ts $JB2TMP/jbrowse-react-circular-genome-view-vanillajs/tracks.js
cp base/circular/defaultSession.ts $JB2TMP/jbrowse-react-circular-genome-view/src/
cp base/circular/defaultSession.ts $JB2TMP/jbrowse-react-circular-genome-view-cra5/src/
cp base/circular/defaultSession.ts $JB2TMP/jbrowse-react-circular-genome-view-vanillajs/defaultSession.js
