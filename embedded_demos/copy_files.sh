#!/bin/bash
## linear
cp base/linear/assembly.ts jbrowse-react-linear-genome-view/src/
cp base/linear/assembly.ts jbrowse-react-linear-genome-view-cra5/src/
cp base/linear/assembly.ts jbrowse-react-linear-genome-view-vite/src/
cp base/linear/assembly.ts jbrowse-react-linear-genome-view-nextjs/utils/
cp base/linear/assembly.ts jbrowse-react-linear-genome-view-vanillajs/assembly.js
cp base/linear/tracks.ts jbrowse-react-linear-genome-view/src/
cp base/linear/tracks.ts jbrowse-react-linear-genome-view-cra5/src/
...
## circular
cp base/circular/assembly.ts jbrowse-react-circular-genome-view/src/
cp base/circular/assembly.ts jbrowse-react-circular-genome-view-cra5/src/
cp base/circular/assembly.ts jbrowse-react-circular-genome-view-vanillajs/assembly.js
