...
| ------ | -------------: | --------: | ------: | ------------: |
| source |            634 |       119 |     515 |         81.2% |
| tests  |            515 |       170 |     345 |         67.0% |
| all    |          1,149 |       289 |     860 |         74.8% |
...
| ------------------------ | ------------------------------------------------------------------ | --------------: |
| track or assembly schema | `name`, `assemblyNames`, `trackId`, `adapter`                      |              72 |
| root config              | `theme`, `extraThemes`, `defaultDriver`, `workerCount`, `shareURL` |              10 |
| everything else          | 26 other names                                                     |              37 |
