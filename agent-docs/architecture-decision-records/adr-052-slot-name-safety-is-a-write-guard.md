...
| ------ | -------------: | --------: | ------: | ------------: |
| source |            650 |       130 |     520 |         80.0% |
| tests  |            564 |       174 |     390 |         69.1% |
| all    |          1,214 |       304 |     910 |         75.0% |
...
| ------------------------ | ------------------------------------------------------------------ | --------------: |
| track or assembly schema | `name`, `assemblyNames`, `trackId`, `adapter`                      |              80 |
| root config              | `theme`, `extraThemes`, `defaultDriver`, `workerCount`, `shareURL` |              10 |
| everything else          | 29 other names                                                     |              40 |
