...
| [057](adr-057-dockview-stays-external.md) | Accepted | dockview stays an npm dependency and is not vendored; whether to REPLACE it with our own MST-native engine is reopened — the ~8-9k-line estimate that ruled it out was wrong, and a measured spike came in smaller than the seam it deletes |
