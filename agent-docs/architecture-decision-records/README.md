...
| [057](adr-057-dockview-stays-external.md) | Accepted | dockview stays an npm dependency — neither vendored nor reimplemented; the friction is two state machines both owning layout, and dockview 8's mutation origin retires most of it |
