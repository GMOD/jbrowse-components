...
`runTransforms` (`plugins/alignments/benches/layoutVsPileupStep.bench.ts`,
...
<!-- BEGIN GENERATED MEASUREMENT layout-vs-pileup-step -->
...
| pileup   | 200,000 | 43.8ms |           219 |     4.23x |
| step     | 200,000 | 28.2ms |           141 |     2.72x |
| features | 200,000 | 12.5ms |            63 |     1.21x |

<!-- END GENERATED MEASUREMENT layout-vs-pileup-step -->
