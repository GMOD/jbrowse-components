...
| [review](review.md) | The link-mark round (de0a383e01..c860b6e68f, ADR-163) reviewed on 2026-09-25. Three findings are fixed; a cross-region link breaks at the seam and never joins in a whole-genome view, GPU blocks past displayed region 255 misplace their own foot, and a link whose far end has no record of its own draws in one block only — each a placement design question, with a probe below. |
