...
| [arabidopsis-1001g-pangenome-demo](arabidopsis-1001g-pangenome-demo.md) | The 1001G+ Arabidopsis demo (26 accessions vs TAIR10) is live on jbrowse.org with SyRI lanes and the lane-order minigraph graph (2026-09-25). Left - add the dataset to jb2hubs. Read before touching demos/arabidopsis_pangenome or its build script. |
