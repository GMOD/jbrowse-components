...
| [grammar-layer-zoom-and-rows](grammar-layer-zoom-and-rows.md) | The planned next phase of the grammar mark layer after ADR-125, ADR-126 and the mark-vs-wiggle measurement (2026-09-16) — line as the first new shape, with wiggle as its second consumer, benched against the hand path before the mark display exposes it. Read before adding a mark shape. |
