...
| [synteny-mates-and-follow-review](synteny-mates-and-follow-review.md) | Findings from two review passes (2026-09-20, 2026-09-21) of the off-screen mate strip and the synteny follow, and a review of the follow fixes. Every bug and UI item has landed or closed; two unconfirmed follow findings and the simplifications remain. Start at "Next session". Read before touching `drawOffscreenMates`, `mateNavDestination`, the mate collection in `executeSyntenyFeaturesAndPositions`, or `SyntenyFollow/`. |
