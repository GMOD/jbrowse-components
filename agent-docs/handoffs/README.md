...
| [review](review.md) | The link-mark round (de0a383e01..c860b6e68f, ADR-163) reviewed on 2026-09-25. The seam, the 256-region foot, and the per-block drawing that cut a link into pieces are fixed, the last by drawing the link over the whole canvas; open are a log size scale below 1, an alias-spelt breakend pair inside one region, the circular ring's link placement, and a far circle's hover box. |
