...
| [alignments-display-review](alignments-display-review.md) | Review of plugins/alignments LinearAlignmentsDisplay — findings, what is being implemented in the alignments-display-review worktree, and what is still open |
