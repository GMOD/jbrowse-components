...
20 registered displays declare 187 config slots, 42 MST properties and 59 volatiles between them — counting what each display's own directory declares.
...
| `MultiWaySyntenyDisplay` | `plugins/linear-comparative-view` | 8 | 4 | 10 |
