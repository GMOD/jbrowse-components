...
22 registered displays declare 241 config slots, 46 MST properties and 53 volatiles between them — counting what each display's own directory declares.
...
| `MultiWaySyntenyDisplay` | `plugins/linear-comparative-view` | 11 | 5 | 12 |
