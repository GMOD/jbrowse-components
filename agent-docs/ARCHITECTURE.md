...
21 registered displays declare 209 config slots, 45 MST properties and 56 volatiles between them — counting what each display's own directory declares.
...
| `LinearMarkDisplay` | `plugins/marks` | 25 | 2 | 0 |
