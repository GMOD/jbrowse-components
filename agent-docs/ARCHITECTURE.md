...
21 registered displays declare 228 config slots, 42 MST properties and 54 volatiles between them — counting what each display's own directory declares.
...
| `MultiWaySyntenyDisplay` | `plugins/linear-comparative-view` | 12 | 3 | 13 |
