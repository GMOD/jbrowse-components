...
22 registered displays declare 232 config slots, 47 MST properties and 58 volatiles between them — counting what each display's own directory declares.
...
| `MultiWaySyntenyDisplay` | `plugins/linear-comparative-view` | 9 | 5 | 12 |
