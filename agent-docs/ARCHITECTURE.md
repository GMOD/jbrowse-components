...
22 registered displays declare 242 config slots, 45 MST properties and 53 volatiles between them — counting what each display's own directory declares.
...
| `MultiWaySyntenyDisplay` | `plugins/linear-comparative-view` | 12 | 4 | 12 |
...
| `ChordSyntenyDisplay` | `plugins/circular-view` | 3 | 3 | 0 |
