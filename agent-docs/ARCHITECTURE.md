...
22 registered displays declare 232 config slots, 47 MST properties and 60 volatiles between them — counting what each display's own directory declares.
...
| `LinearBasicDisplay` | `plugins/canvas` | 27 | 8 | 13 |
