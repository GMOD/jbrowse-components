...
20 registered displays declare 255 config slots, 43 MST properties and 62 volatiles between them — counting what each display's own directory declares.
...
| `MultiWaySyntenyDisplay` | `plugins/linear-comparative-view` | 14 | 3 | 18 |
