...
20 registered displays declare 187 config slots, 44 MST properties and 55 volatiles between them — counting what each display's own directory declares.
...
| `MultiWaySyntenyDisplay` | `plugins/linear-comparative-view` | 9 | 6 | 11 |
