...
18 registered displays declare 250 config slots, 41 MST properties and 58 volatiles between them — counting what each display's own directory declares.
...
| `LinearHicDisplay` | `plugins/hic` | 8 | 2 | 1 |
