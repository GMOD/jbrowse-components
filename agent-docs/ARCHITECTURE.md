...
22 registered displays declare 244 config slots, 42 MST properties and 53 volatiles between them — counting what each display's own directory declares.
...
| `MultiWaySyntenyDisplay` | `plugins/linear-comparative-view` | 15 | 3 | 12 |
| `LinearMultiRowFeatureDisplay` | `plugins/canvas` | 12 | 3 | 0 |
| `LDDisplay` | `plugins/variants` | 11 | 0 | 2 |
| `LinearManhattanDisplay` | `plugins/gwas` | 10 | 3 | 0 |
