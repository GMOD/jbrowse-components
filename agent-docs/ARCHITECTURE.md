...
22 registered displays declare 239 config slots, 46 MST properties and 53 volatiles between them — counting what each display's own directory declares.
...
| `LinearBasicDisplay` | `plugins/canvas` | 30 | 8 | 12 |
