...
20 registered displays declare 188 config slots, 42 MST properties and 60 volatiles between them — counting what each display's own directory declares.
...
| `MultiLinearWiggleDisplay` | `plugins/wiggle` | 4 | 0 | 0 |
