...
21 registered displays declare 210 config slots, 45 MST properties and 56 volatiles between them — counting what each display's own directory declares.
...
| `LinearMarkDisplay` | `plugins/marks` | 26 | 2 | 0 |
