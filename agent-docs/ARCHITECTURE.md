...
21 registered displays declare 227 config slots, 42 MST properties and 53 volatiles between them — counting what each display's own directory declares.
...
| `LinearWiggleDisplay` | `plugins/wiggle` | 8 | 2 | 0 |
