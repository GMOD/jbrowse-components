...
21 registered displays declare 241 config slots, 42 MST properties and 59 volatiles between them — counting what each display's own directory declares.
...
| `LinearMafDisplay` | `plugins/maf` | 22 | 2 | 5 |
