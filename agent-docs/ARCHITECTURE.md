...
22 registered displays declare 245 config slots, 42 MST properties and 53 volatiles between them — counting what each display's own directory declares.
...
| `LinearBasicDisplay` | `plugins/canvas` | 31 | 8 | 12 |
| `LinearMafDisplay` | `plugins/maf` | 20 | 2 | 4 |
| `MultiWaySyntenyDisplay` | `plugins/linear-comparative-view` | 13 | 3 | 12 |
