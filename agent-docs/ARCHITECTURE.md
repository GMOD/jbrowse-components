...
20 registered displays declare 255 config slots, 43 MST properties and 61 volatiles between them — counting what each display's own directory declares.

<!-- prettier-ignore -->
| Display | Plugin | `#slot` | `#property` | `#volatile` |
| --- | --- | --- | --- | --- |
| `LinearMarkDisplay` | `plugins/marks` | 51 | 2 | 1 |
...
| `MultiWaySyntenyDisplay` | `plugins/linear-comparative-view` | 14 | 3 | 17 |
| `LinearMultiRowFeatureDisplay` | `plugins/canvas` | 12 | 3 | 0 |
| `LDDisplay` | `plugins/variants` | 11 | 0 | 2 |
| `LinearHicDisplay` | `plugins/hic` | 9 | 2 | 2 |
