...
22 registered displays declare 234 config slots, 48 MST properties and 59 volatiles between them — counting what each display's own directory declares.
...
| `ChordSyntenyDisplay` | `plugins/circular-view` | 3 | 4 | 3 |
