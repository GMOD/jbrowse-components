...
22 registered displays declare 237 config slots, 46 MST properties and 53 volatiles between them — counting what each display's own directory declares.
...
| `LinearMultiRowFeatureDisplay` | `plugins/canvas` | 13 | 3 | 0 |
