...
19 registered displays declare 179 config slots, 40 MST properties and 52 volatiles between them — counting what each display's own directory declares.
...
| `LDDisplay` | `plugins/variants` | 16 | 1 | 2 |
