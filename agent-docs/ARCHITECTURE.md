...
20 registered displays declare 186 config slots, 42 MST properties and 61 volatiles between them — counting what each display's own directory declares.
...
| `LinearMafDisplay` | `plugins/maf` | 20 | 2 | 8 |
