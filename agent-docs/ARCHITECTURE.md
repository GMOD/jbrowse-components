...
21 registered displays declare 235 config slots, 42 MST properties and 58 volatiles between them — counting what each display's own directory declares.
