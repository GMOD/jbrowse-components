...
18 registered displays declare 244 config slots, 41 MST properties and 59 volatiles between them — counting what each display's own directory declares.

<!-- prettier-ignore -->
| Display | Plugin | `#slot` | `#property` | `#volatile` |
| --- | --- | --- | --- | --- |
| `LinearMarkDisplay` | `plugins/marks` | 57 | 2 | 1 |
...
| `LinearManhattanDisplay` | `plugins/gwas` | 5 | 3 | 0 |
