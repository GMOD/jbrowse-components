...
18 registered displays declare 250 config slots, 41 MST properties and 59 volatiles between them — counting what each display's own directory declares.

<!-- prettier-ignore -->
| Display | Plugin | `#slot` | `#property` | `#volatile` |
| --- | --- | --- | --- | --- |
| `LinearMarkDisplay` | `plugins/marks` | 59 | 2 | 1 |
| `LinearAlignmentsDisplay` | `plugins/alignments` | 47 | 2 | 12 |
