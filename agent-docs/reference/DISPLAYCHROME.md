...
20 display types are registered for `LinearGenomeView`: 17 on `DisplayChrome`, 3 on `DisplayStatusChrome`. On export, 0 of 20 reach `SvgChrome`.
...
| MultiWaySyntenyDisplay | `DisplayStatusChrome` | `plugins/linear-comparative-view/src/MultiWaySyntenyDisplay/components/ReactComponent.tsx` | — | `plugins/linear-comparative-view/src/MultiWaySyntenyDisplay/renderSvg.tsx` |
