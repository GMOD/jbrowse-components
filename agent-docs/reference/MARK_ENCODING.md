...
| -------------------- | ----------: | --------: | ---: | -----: | ------: | -----: | --------------: | ----------------: | ------------------------: | -----: | ------------------: |
| volvox_microarray.bw |         870 |       raw |  500 | 0.11ms |  0.10ms | 0.41ms |           3.73x |            0.61ms |                         — |      — |                   — |
| volvox_microarray.bw |       3,478 |      3478 |   15 | 0.07ms |  0.07ms | 0.09ms |           1.29x |            0.11ms |                     5.60% | 11.61% |               5.36% |
| volvox_microarray.bw |      13,912 |     13912 |    4 | 0.07ms |  0.06ms | 0.08ms |           1.14x |            0.09ms |                     1.39% |  1.39% |               0.14% |
| volvox_microarray.bw |      55,648 |     55648 |    1 | 0.06ms |  0.05ms | 0.07ms |           1.17x |            0.08ms |                     0.14% |  0.14% |               0.14% |
| CD16_Mono.bw         |         100 |       raw |  622 | 0.20ms |  0.20ms | 0.43ms |           2.15x |            0.84ms |                         — |      — |                   — |
| CD16_Mono.bw         |         400 |       400 |  386 | 0.15ms |  0.15ms | 0.26ms |           1.73x |            0.55ms |                     0.28% |  7.25% |               0.28% |
| CD16_Mono.bw         |       1,600 |      1600 |  534 | 0.17ms |  0.16ms | 0.31ms |           1.82x |            0.63ms |                     0.22% |  7.93% |               0.18% |
| CD16_Mono.bw         |       6,400 |      6400 |  570 | 0.25ms |  0.24ms | 0.42ms |           1.68x |            0.57ms |                     0.16% |  1.90% |               0.11% |
| CD16_Mono.bw         |      25,600 |     25600 |  906 | 0.51ms |  0.52ms | 1.03ms |           2.02x |            1.52ms |                     0.04% |  0.64% |               0.04% |
| CD16_Mono.bw         |     102,400 |    102400 |  866 | 0.21ms |  0.20ms | 0.46ms |           2.19x |            0.71ms |                     0.04% |  1.24% |               0.04% |
| CD16_Mono.bw         |     409,600 |    409600 |  471 | 0.20ms |  0.20ms | 0.34ms |           1.70x |            0.46ms |                     0.03% |  0.22% |               0.03% |
| CD16_Mono.bw         |   1,638,400 |   1638400 |  136 | 0.34ms |  0.33ms | 0.44ms |           1.29x |            0.53ms |                     0.03% |  0.26% |               0.03% |
| CD16_Mono.bw         |   6,553,600 |   6553600 |   37 | 0.20ms |  0.20ms | 0.28ms |           1.40x |            0.28ms |                     0.02% |  0.06% |               0.02% |
| CD16_Mono.bw         |  26,214,400 |  26214400 |   11 | 0.13ms |  0.11ms | 0.14ms |           1.08x |            0.15ms |                     0.01% |  0.01% |               0.01% |
| CD16_Mono.bw         | 104,857,600 | 104857600 |    3 | 0.08ms |  0.06ms | 0.11ms |           1.38x |            0.12ms |                     0.00% |  0.00% |               0.00% |
...
to a thousand, and the mark path's work over them is between one and four
times the hand path's and under half a millisecond in every row but one: the
...
coverage file and within a few percent over volvox's fifteen-row tier, with
the worst bin inside twelve percent; a span-weighted mean, which is what a
`validCnt` would buy on data this dense, moves the average by a quarter of a
point at most. `@gmod/bbi` keeps its count.
