...
description: What is left from the audit of packages/core/src/util — the open typing items, the dead code that is a plugin-ABI decision, and the list verified clean. Read before re-auditing core/util or deleting something there that looks unused.
audience: internal
kind: measurement
---
