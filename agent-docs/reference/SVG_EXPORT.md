...
| `packages/display-kit/src/GlobalFetchMixin.ts` | `self.loadedFetchKey` | `self.currentFetchKey` |
| `packages/synteny-core/src/comparativeFetchFlags.ts` | `self.loadedFetchKey` | `comparativeFetchKey(self)` |
