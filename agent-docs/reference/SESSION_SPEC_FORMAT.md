...
| -------------------------------------- | ----: |
| session specs                          |   385 |
| views, nested ones included            |   620 |
| session tracks carried inline          |   178 |
| track entries: bare id                 |   123 |
| track entries: tuple                   |   103 |
| track entries: object                  |   606 |
| explicit display types named           |    15 |
| distinct keys on object entries        |    81 |
| keys on two or more display types      |    18 |
| keys used exactly once                 |    18 |
