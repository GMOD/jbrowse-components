...
| -------------------------------------- | ----: |
| session specs                          |   380 |
| views, nested ones included            |   605 |
| session tracks carried inline          |   185 |
| track entries: bare id                 |   103 |
| track entries: tuple                   |    92 |
| track entries: object                  |   600 |
| explicit display types named           |    19 |
| distinct keys on object entries        |    95 |
| keys on two or more display types      |    29 |
| keys used exactly once                 |    23 |
...
| colorBy             |      26 |             3 |
| groupBy             |      18 |             3 |
| summaryScoreMode    |      16 |             2 |
| jexlFiltersSetting  |      15 |             2 |
