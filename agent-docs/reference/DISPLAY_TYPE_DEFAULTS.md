...
| `scatterPointSize` | <code>4</code> | `plugins/marks/src/LinearMarkDisplay/configSchema.ts` | LinearMarkDisplay |
...
| `showLegend` | <code>true</code> | `plugins/gwas/src/LinearManhattanDisplay/configSchemaFactory.ts` | LinearManhattanDisplay |
...
| `showLegend` | <code>true</code> | `plugins/marks/src/LinearMarkDisplay/configSchema.ts` | LinearMarkDisplay |
| `showLegend` | <code>false</code> | `plugins/variants/src/LDDisplay/configSchemaLDTrack.ts` | LDTrackDisplay |
...
| `showLegend` | <code>true</code> | `plugins/wiggle/src/LinearWiggleDisplay/configSchema.ts` | LinearGCContentDisplay, LinearGCContentTrackDisplay, LinearWiggleDisplay |
