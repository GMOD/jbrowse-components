...
| `colorRampLut` | 4 | `hic/hic`, `render-core/markColor`, `variants/ldUniforms`, `wiggle/wiggleDensity` |
...
| `hpmath` | 45 | _most of the tree_ |
| `markColor` | 2 | `render-core/barMark`, `render-core/pointMark` |
| `pointGlyph` | 2 | `render-core/pointMark`, `wiggle/wiggle` |
| `pointMark` | 0 | — |
| `rowRect` | 2 | `render-core/spanMark`, `wiggle/wiggleDensity` |
| `scoreScale` | 5 | `render-core/coverageBand`, `render-core/markColor`, `render-core/valueScale`, `wiggle/wiggleCommon`, `wiggle/wiggleDensity` |
| `spanMark` | 0 | — |
| `valueScale` | 2 | `render-core/barMark`, `render-core/pointMark` |
