...
| --- | --- | --- |
| `antialias` | 17 | _most of the tree_ |
| `barMark` | 0 | — |
| `capsule` | 3 | `alignments/linkedReadLine`, `dotplot-view/dotplot`, `wiggle/wiggleLineCenter` |
| `colorPack` | 33 | _most of the tree_ |
...
| `coverageMod` | 0 | — |
| `coverageSnp` | 0 | — |
| `curveDistance` | 2 | `alignments/arc`, `render-core/linkMark` |
| `diagonalGrid` | 2 | `hic/hic`, `variants/ldUniforms` |
| `hpmath` | 46 | _most of the tree_ |
| `linkMark` | 0 | — |
| `markColor` | 3 | `render-core/barMark`, `render-core/linkMark`, `render-core/pointMark` |
| `pointGlyph` | 2 | `render-core/pointMark`, `wiggle/wiggle` |
| `pointMark` | 0 | — |
| `rowRect` | 2 | `render-core/spanMark`, `wiggle/wiggleDensity` |
| `rowTable` | 1 | `render-core/spanMark` |
| `scoreScale` | 8 | `hic/hic`, `render-core/coverageBand`, `render-core/linkMark`, `render-core/markColor`, `render-core/valueScale`, `wiggle/wiggle`, `wiggle/wiggleCommon`, `wiggle/wiggleDensity` |
| `spanMark` | 0 | — |
| `valueScale` | 4 | `render-core/barMark`, `render-core/linkMark`, `render-core/pointMark`, `wiggle/wiggleCommon` |
