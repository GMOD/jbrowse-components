...
| `GOTCHA` | `website/docs/config_guides/connections.md`<br />`website/docs/config_guides/customizing_feature_colors.md`<br />`website/docs/config_guides/synteny_track.md` |
| `GRAPH_PLUGIN_CONFIG` | `website/docs/tutorials/pangenome_prepare_graph.md`<br />`website/docs/user_guides/graph_genome_view.md` |
...
| `MARK_RULES` | `website/docs/config_guides/mark_display.md` |
...
| `SHADER_SHAPE_CONSUMERS` | `agent-docs/reference/SHADER_SHAPE_LIBRARY.md` |
