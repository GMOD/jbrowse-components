...
cannot give it. Whether that picture holds at a locus is a property of the
graph's snarl structure and not of the window, so it has to be cut to find out.
...
| --------------------- | ------: | -----: | -----: | -----: | -----: | ------: | ---------: | ----------: | ------------: |
| ABCA7 VNTR chr19      |     689 |     56 |   14.3 |   4.59 | 13,153 |     474 |        459 |          12 |           444 |
| C4 chr6               |  83,361 |    5.4 |   10.8 |   4.19 |  4,978 |     464 |        463 |           0 |           462 |
| CFHR3/CFHR1 chr1      |  84,683 |    8.6 |   11.1 |   4.32 |  6,053 |     464 |        463 |           0 |           463 |
| amylase chr1          | 121,556 |     14 |   18.7 |   5.96 |  6,469 |     934 |        463 |         296 |           168 |
| 1q21.1 inversion chr1 | 153,166 |   18.5 |     38 |    7.2 | 17,933 |     825 |        453 |         342 |           114 |
| CFH demo window chr1  | 260,000 |   13.8 |   36.8 |   5.37 | 16,372 |     466 |        463 |           2 |           452 |
...
| haplotype | W lines | walk span bp | vs GRCh38 |
| --------- | ------: | -----------: | --------: |
| GRCh38#0  |       1 |      121,557 |         0 |
| HG01361#1 |       1 |       27,342 |   -94,215 |
| HG00133#2 |       1 |       49,048 |   -72,509 |
| HG01361#2 |       1 |      121,470 |       -87 |
| HG00133#1 |       1 |      121,488 |       -69 |
| NA18608#2 |       1 |      215,595 |    94,038 |
| NA18608#1 |       1 |      309,708 |   188,151 |
| HG00232#1 |       1 |      309,719 |   188,162 |
| HG00232#2 |       1 |      318,428 |   196,871 |

<!-- END GENERATED MEASUREMENT gbz-keep-set-cut -->

It is a different extraction rather than a smaller one, so the node count rises
against the cohort cut. What it does not rescue is the node limit: 1q21.1 still
exceeds 50,000 with the same keep set, because that ceiling belongs to the graph
in the window and not to the walks asked for.
...
| locus                | span bp | wall s | distinct forms | haplotypes | top weight | top form nodes | median nodes |
| -------------------- | ------: | -----: | -------------: | ---------: | ---------: | -------------: | -----------: |
| ABCA7 VNTR chr19     |     689 |    126 |            465 |        474 |          2 |          3,974 |        3,164 |
| C4 chr6              |  83,361 |   16.6 |            395 |        464 |          9 |          1,574 |        2,331 |
| CFHR3/CFHR1 chr1     |  84,683 |   18.4 |            342 |        464 |         97 |            345 |        3,976 |
| amylase chr1         | 121,556 |   21.2 |            725 |        934 |         20 |            203 |        1,217 |
| CFH demo window chr1 | 260,000 |     45 |            466 |        466 |          1 |         10,764 |       10,717 |
