...
Moved out of [multi-sample-variant-display](../collections/multi-sample-variant-display.md) on
...
the decline of a second consumer on the shared y scale named as its reopen
condition: _"a second display
...
- **Not a wiggle track alongside.** A bedGraph export of the statistic is a
  separate, cheaper idea ([alignments](../collections/alignments.md) has the coverage-band
