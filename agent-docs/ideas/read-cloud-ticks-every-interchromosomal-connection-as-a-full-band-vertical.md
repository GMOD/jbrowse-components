...
what v5.0.0 turns on. Reported from use rather than measured as wrong, and a
tick carries two things — the partner name and the support width — that the
obvious replacement does not.
