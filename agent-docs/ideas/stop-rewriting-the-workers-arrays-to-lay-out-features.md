...
what v5.0.0 turns on. The wide version wants a session of its own and changes a
plugin-ABI type; the cheap wire-format half is real and still nothing the
release turns on.
