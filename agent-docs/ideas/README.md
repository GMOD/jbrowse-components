...
| [track-type-from-config-schema](track-type-from-config-schema.md) | adapterTypesToTrackTypeMap restates the #trackType tag every adapter config schema already carries; generating it would close the last hand-copied half of the add-track table. |
