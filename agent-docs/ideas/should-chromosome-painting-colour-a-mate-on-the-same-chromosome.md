...
what v5.0.0 turns on. The half that could paint a translocated read the
background colour exactly is closed; what is left is a question about which
picture reads better.
