...
| **[EFFECTIVE_GETTER_AUDIT.md](guides/EFFECTIVE_GETTER_AUDIT.md)**         | Auditing the `effectiveRowHeight`-style resolved-getter vs. raw-sentinel-prop convention | Auditing sentinel props; adding an `effective*` getter |
