...
→ See ARCHITECTURE.md "Adding a new GPU display type" (7-step walkthrough with code examples)

**"How do I debug failing browser tests?"**  
→ See TEST_INFRASTRUCTURE.md "Debugging" (visual mismatches, timeouts, console logs)
...
→ See ARCHITECTURE.md (layers, lifecycle, multi-region pattern) or ADR files (design decisions)
