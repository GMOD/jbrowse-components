...
This allows users to easily filter the variants in the feature detail widget by
genotype. It can also be toggled to filter by 'dosage' which is helpful for
polyploid organisms
