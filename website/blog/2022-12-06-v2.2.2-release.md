...
split view with "TRA" type features not being displayed. See release notes
below for a couple other small bugfixes and enhancements.
...
- Other
  - [#3350](https://github.com/GMOD/jbrowse-components/pull/3350) Retain feature labels in compact display mode for SVG features, and allow keeping feature description without feature label ([@cmdcolin](https://github.com/cmdcolin))
