...
- Ability to load a session from a URL in JBrowse Web, for example,
  https://jbrowse.org/code/jb2/v1.6.3/?config=test_data/volvox/config.json&loc=ctgA:2000-40000&assembly=volvox&tracks=gff3tabix_genes,volvox_filtered_vcf,volvox_microarray,volvox_cram
...
Screenshot showing the new curvy lines of the synteny view with the grape vs peach demo http://jbrowse.org/code/jb2/v1.6.3/?config=test_data%2Fconfig_synteny_grape_peach.json&session=share-EdWfJj5aIY&password=S8PGj
