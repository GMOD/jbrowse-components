...
# still exits 0, because the last command is the invalidation: a build that died
# on a docs gate reads as a successful deploy. What saved it the one time this
# happened was rclone refusing to delete after an IO error, which is a safety
