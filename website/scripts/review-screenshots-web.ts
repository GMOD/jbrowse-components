...
// write protocol and note-draft bookkeeping are shared with jbrowse-web's
// browser-test snapshot review (@jbrowse/browser-test-utils/reviewApp); this
// entry supplies the two halves that differ, what a card looks like and what the
// header counts.
//
