...
// A section's own ```bash block comes out first. It contributes no code span,
...
// Prerequisites ends in a fence. Stripping per section, before the join, keeps
// one part's fence from pairing with the next part's.
