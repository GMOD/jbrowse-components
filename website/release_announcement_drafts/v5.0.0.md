...
cores under `packages/` are what the plugins were factored into. The total still
grew every week of the release, which is the shape of the figure above — what
