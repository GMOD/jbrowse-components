...
To satisfy these goals we targeted WebGPU, a newer web platform API. This is not
broadly enabled on all users web browsers yet though, and it also requires
