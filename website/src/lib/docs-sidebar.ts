...
// Ancestor group labels of a page, outermost first ("User guide", "Track
// types"), for the breadcrumb above its h1. Derived from the resolved sidebar
// for the same reason buildSearchCategoryMap is: the guide_category subgroups
// only exist after buildSidebar expands the autogenerated directories, so a
// second walk of the raw sidebars.json could not see them, and any hand-listed
// copy would drift when a page moves. The current page itself is not included
