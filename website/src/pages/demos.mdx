...
These demos contain examples of new workflows and views in JBrowse 2, with
links to live sessions on the web in order for you to be able to experience the
app yourself. The link above will always direct to the most recent demo that
has been released.
