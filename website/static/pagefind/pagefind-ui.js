;(() => {
  ...
  var x = (l, e) => {
    for (var t in e) Os(l, t, { get: e[t], enumerable: !0 })
  }
  function R() {}
  function Bt(l) {
    return l()
  ...
  function O(l, e) {
    return l != l
      ? e == e
      : l !== e || (l && typeof l == 'object') || typeof l == 'function'
  }
  var ot
  function ge(l, e) {
    return l === e
      ? !0
      : (ot || (ot = document.createElement('a')), (ot.href = e), l === ot.href)
  }
  function Wl(l) {
  ...
  var Ct = class l {
    _listeners = 'WeakMap' in ht ? new WeakMap() : void 0
    _observer = void 0
    options
    constructor(e) {
      this.options = e
    ...
    _getObserver() {
      return (
        ...
        (this._observer = new ResizeObserver(e => {
          for (let t of e)
            (l.entries.set(t.target, t), this._listeners.get(t.target)?.(t))
        }))
      )
    }
  }
  Ct.entries = 'WeakMap' in ht ? new WeakMap() : void 0
  var Sl = !1
  function Vl() {
    Sl = !0
  }
  ...
  function _(l, e, t) {
    t == null
      ? l.removeAttribute(e)
      : l.getAttribute(e) !== t && l.setAttribute(e, t)
  }
  function Tl(l) {
  ...
  function aa(l) {
    if (l.fragment !== null) {
      ;(l.update(), H(l.before_update))
      let e = l.dirty
      ;((l.dirty = [-1]),
        l.fragment && l.fragment.p(l.ctx, e),
        l.after_update.forEach(Ae))
    }
  }
  function wl(l) {
    let e = [],
      t = []
    ;(ue.forEach(s => (l.indexOf(s) === -1 ? e.push(s) : t.push(s))),
      t.forEach(s => s()),
      (ue = e))
  }
  var At = new Set(),
  ...
  function Jl(l, e, t, s, a, r, i, n, g, C, u, A) {
    let c = l.length,
      d = r.length,
      o = c,
      I = {}
    ...
    for (o = d; o--; ) {
      let N = A(a, r, o),
        S = t(N),
        E = i.get(S)
      ;(E ? s && U.push(() => E.p(N, e)) : ((E = C(S, N)), E.c()),
        f.set(S, (m[o] = E)),
        S in I && p.set(S, Math.abs(o - I[S])))
    }
    let y = new Set(),
      q = new Set()
    function J(N) {
  ...
  function _e(l, e, t) {
    let { fragment: s, after_update: a } = l.$$
    ;(s && s.m(e, t),
      Ae(() => {
        let r = l.$$.on_mount.map(Bt).filter(ut)
        ;(l.$$.on_destroy ? l.$$.on_destroy.push(...r) : H(r),
          (l.$$.on_mount = []))
      }),
      a.forEach(Ae))
  }
  ...
  function ga(l, e) {
    ;(l.$$.dirty[0] === -1 && (se.push(l), Ml(), l.$$.dirty.fill(0)),
      (l.$$.dirty[(e / 31) | 0] |= 1 << (e % 31)))
  }
  function K(l, e, t, s, a, r, i = null, n = [-1]) {
    let g = te
    j(l)
    let C = (l.$$ = {
      fragment: null,
    ...
    if (
      ((C.ctx = t
        ? t(l, e.props || {}, (A, c, ...d) => {
            let o = d.length ? d[0] : c
            return (
              C.ctx &&
                a(C.ctx[A], (C.ctx[A] = o)) &&
                (!C.skip_bound && C.bound[A] && C.bound[A](o), u && ga(l, A)),
              c
            )
          })
        : []),
      ...
      ;(e.intro && k(l.$$.fragment), _e(l, e.target, e.anchor), Dl(), dt())
    }
    j(g)
  }
  var oa
  typeof HTMLElement == 'function' &&
    (oa = class extends HTMLElement {
      $$ctor
      $$s
      $$c
      $$cn = !1
      ...
      addEventListener(l, e, t) {
        if (
          ((this.$$l[l] = this.$$l[l] || []), this.$$l[l].push(e), this.$$c)
        ) {
          let s = this.$$c.$on(l, e)
          this.$$l_u.set(e, s)
        }
        super.addEventListener(l, e, t)
      }
      removeEventListener(l, e, t) {
        if ((super.removeEventListener(l, e, t), this.$$c)) {
          let s = this.$$l_u.get(e)
          s && (s(), this.$$l_u.delete(e))
        }
        if (this.$$l[l]) {
          let s = this.$$l[l].indexOf(e)
          s >= 0 && this.$$l[l].splice(s, 1)
        }
      }
      async connectedCallback() {
        if (((this.$$cn = !0), !this.$$c)) {
          ...
          let e = {},
            t = vl(this)
          for (let a of this.$$s) a in t && (e[a] = [l(a)])
          for (let a of this.attributes) {
            let r = this.$$g_p(a.name)
            r in this.$$d ||
              (this.$$d[r] = Xt(r, a.value, this.$$p_d, 'toProp'))
          }
          for (let a in this.$$p_d)
            !(a in this.$$d) &&
              this[a] !== void 0 &&
          ...
          let s = () => {
            ...
            for (let a in this.$$p_d)
              if (
                ((this.$$d[a] = this.$$c.$$.ctx[this.$$c.$$.props[a]]),
                this.$$p_d[a].reflect)
              ) {
                let r = Xt(a, this.$$d[a], this.$$p_d, 'toAttribute')
                r == null
                  ? this.removeAttribute(this.$$p_d[a].attribute || a)
                  : this.setAttribute(this.$$p_d[a].attribute || a, r)
              }
            this.$$r = !1
          }
          ;(this.$$c.$$.after_update.push(s), s())
          for (let a in this.$$l)
            for (let r of this.$$l[a]) {
              let i = this.$$c.$on(a, r)
              this.$$l_u.set(r, i)
            }
          this.$$l = {}
      ...
      attributeChangedCallback(l, e, t) {
        this.$$r ||
          ((l = this.$$g_p(l)),
          (this.$$d[l] = Xt(l, t, this.$$p_d, 'toProp')),
          this.$$c?.$set({ [l]: this.$$d[l] }))
      }
      ...
      $$g_p(l) {
        return (
          Object.keys(this.$$p_d).find(
            e =>
              this.$$p_d[e].attribute === l ||
              (!this.$$p_d[e].attribute && e.toLowerCase() === l),
          ) || l
        )
      }
    })
  function Xt(l, e, t, s) {
    let a = t[l]?.type
    if (
      ((e = a === 'Boolean' && typeof e != 'boolean' ? e != null : e),
      !s || !t[l])
    )
      return e
    if (s === 'toAttribute')
  ...
  function T(l) {
    let e = typeof l == 'string' ? l.charCodeAt(0) : l
  ...
  function Qt(l, e = {}) {
    let t = Kl(),
      ...
      a = s.toLowerCase(),
      r = 0
    if (l == null) throw new Error('Expected string, got `' + l + '`')
    if (ua.call(Et, a)) {
      let n = Et[a]
    ...
    if (r > 1 && r < 9) {
      ...
      for (
        ...
        if (g - n > 4 || (g - n > 3 && le(a.charCodeAt(n))))
          (t.variants.push(s.slice(n, g)), (r = g))
        else break
      }
      for (
        ;
        ...
        ;(t.extensions.push({
          ...
          extensions: s.slice(r + 3, n).split('-'),
        }),
          (r = n))
      }
    } else r = 0
    if (
      (r === 0 && a.charCodeAt(r) === 120) ||
      (a.charCodeAt(r) === 45 && a.charCodeAt(r + 1) === 120)
    ) {
      r = r ? r + 2 : 1
      let n = r
      for (; a.charCodeAt(n) === 45 && P(a.charCodeAt(n + 1)); ) {
        ...
        ;(t.privateuse.push(s.slice(r + 1, n)), (r = n))
      }
    }
    if (r !== s.length) return i(r, 6, 'Found superfluous content after tag')
    return t
    function i(n, g, C) {
      return (e.warning && e.warning(C, g, n), e.forgiving ? t : Kl())
    }
  }
  function Kl() {
    return {
    ...
    return {
      c() {
        ;(i && i.c(),
          ...
          (t = F('div')),
          (s = F('p')),
          (s.textContent = `${l[3](30)}`),
          (a = Z()),
          (r = F('p')),
          (r.textContent = `${l[3](40)}`),
          _(
            s,
            'class',
          ...
          _(t, 'class', 'pagefind-ui__result-inner svelte-j9e30'))
      },
      m(n, g) {
        ;(i && i.m(n, g), h(n, e, g), h(n, t, g), b(t, s), b(t, a), b(t, r))
      },
      p(n, g) {
        n[0]
          ? i || ((i = ql(n)), i.c(), i.m(e.parentNode, e))
          : i && (i.d(1), (i = null))
      },
      d(n) {
        ;(n && (B(e), B(t)), i && i.d(n))
    ...
    return {
      c() {
        ;(c && c.c(),
          ...
          (A = Z()),
          d && d.c(),
          _(a, 'class', 'pagefind-ui__result-link svelte-j9e30'),
          _(a, 'href', (n = l[1].meta?.url || l[1].url)),
          _(s, 'class', 'pagefind-ui__result-title svelte-j9e30'),
          _(C, 'class', 'pagefind-ui__result-excerpt svelte-j9e30'),
          _(t, 'class', 'pagefind-ui__result-inner svelte-j9e30'))
      },
      m(o, I) {
        ;(c && c.m(o, I),
      ...
      p(o, I) {
        ;(o[0]
          ? c
            ? c.p(o, I)
            : ((c = $l(o)), c.c(), c.m(e.parentNode, e))
          : c && (c.d(1), (c = null)),
          I & 2 && r !== (r = o[1].meta?.title + '') && W(i, r),
          I & 2 && n !== (n = o[1].meta?.url || o[1].url) && _(a, 'href', n),
          I & 2 && u !== (u = o[1].excerpt + '') && (C.innerHTML = u),
          o[2].length
            ? d
              ? d.p(o, I)
              : ((d = ts(o)), d.c(), d.m(t, null))
            : d && (d.d(1), (d = null)))
      },
      d(o) {
        ;(o && (B(e), B(t)), c && c.d(o), d && d.d())
      },
    }
  }
  function ql(l) {
  ...
  function $l(l) {
    let e,
      t = l[1].meta.image && es(l)
    return {
      c() {
        ;((e = F('div')),
          t && t.c(),
          _(e, 'class', 'pagefind-ui__result-thumb svelte-j9e30'))
      },
      m(s, a) {
        ;(h(s, e, a), t && t.m(e, null))
      },
      p(s, a) {
        s[1].meta.image
          ? t
            ? t.p(s, a)
            : ((t = es(s)), t.c(), t.m(e, null))
          : t && (t.d(1), (t = null))
      },
      d(s) {
        ;(s && B(e), t && t.d())
  ...
  function es(l) {
    ...
    return {
      c() {
        ;((e = F('img')),
          _(e, 'class', 'pagefind-ui__result-image svelte-j9e30'),
          ge(e.src, (t = l[1].meta?.image)) || _(e, 'src', t),
          _(e, 'alt', (s = l[1].meta?.image_alt || l[1].meta?.title)))
      },
      m(a, r) {
        h(a, e, r)
      },
      p(a, r) {
        ;(r & 2 && !ge(e.src, (t = a[1].meta?.image)) && _(e, 'src', t),
          r & 2 &&
            s !== (s = a[1].meta?.image_alt || a[1].meta?.title) &&
            _(e, 'alt', s))
      },
      d(a) {
        a && B(e)
  ...
  function ts(l) {
    let e,
      t = V(l[2]),
      s = []
    for (let a = 0; a < t.length; a += 1) s[a] = ls(Pl(l, t, a))
    return {
      c() {
        e = F('ul')
        for (let a = 0; a < s.length; a += 1) s[a].c()
        _(e, 'class', 'pagefind-ui__result-tags svelte-j9e30')
      },
      m(a, r) {
        h(a, e, r)
      ...
      p(a, r) {
        if (r & 4) {
          ...
          for (i = 0; i < t.length; i += 1) {
            let n = Pl(a, t, i)
            s[i] ? s[i].p(n, r) : ((s[i] = ls(n)), s[i].c(), s[i].m(e, null))
          }
    ...
    return {
      c() {
        ;((e = F('li')),
          ...
          (i = G(r)),
          (n = Z()),
          _(e, 'class', 'pagefind-ui__result-tag svelte-j9e30'),
          _(e, 'data-pagefind-ui-meta', (g = l[9])))
      },
      m(C, u) {
        ;(h(C, e, u), b(e, s), b(e, a), b(e, i), b(e, n))
      },
      p(C, u) {
        ;(u & 4 && t !== (t = C[9].replace(/^(\w)/, ss) + '') && W(s, t),
          u & 4 && r !== (r = C[10] + '') && W(i, r),
          u & 4 && g !== (g = C[9]) && _(e, 'data-pagefind-ui-meta', g))
      },
      d(C) {
        C && B(e)
      },
  ...
  function da(l) {
    ...
    return {
      c() {
        ;((e = F('li')),
          a.c(),
          _(e, 'class', 'pagefind-ui__result svelte-j9e30'))
      },
      m(r, i) {
        ;(h(r, e, i), a.m(e, null))
      },
    ...
    let { show_images: s = !0 } = e,
      ...
      C = (c, d) => {
        if (
          ...
          return c
        try {
          return new URL(c, new URL(d || '/', 'https://p')).pathname
        } catch {
          return c
        }
      },
          ...
          n.meta?.image &&
            t(
              ...
              (n = {
                ...
                meta: {
                  ...n.meta,
                  image: C(n.meta.image, n.meta.url || n.url),
                },
              }),
            ),
          t(2, (g = Object.entries(n.meta).filter(([d]) => !i.includes(d)))))
      },
      A = (c = 30) => '. '.repeat(Math.floor(10 + Math.random() * c))
    return (
      (l.$$set = c => {
        ;('show_images' in c && t(0, (s = c.show_images)),
          'process_result' in c && t(4, (a = c.process_result)),
          'result' in c && t(5, (r = c.result)))
      }),
      (l.$$.update = () => {
        l.$$.dirty & 32 && u(r)
      }),
    ...
    return {
      c() {
        ;(i && i.c(),
          ...
          (t = F('div')),
          (s = F('p')),
          (s.textContent = `${l[5](30)}`),
          (a = Z()),
          (r = F('p')),
          (r.textContent = `${l[5](40)}`),
          _(
            s,
            'class',
          ...
          _(t, 'class', 'pagefind-ui__result-inner svelte-4xnkmf'))
      },
      m(n, g) {
        ;(i && i.m(n, g), h(n, e, g), h(n, t, g), b(t, s), b(t, a), b(t, r))
      },
      p(n, g) {
        n[0]
          ? i || ((i = ns(n)), i.c(), i.m(e.parentNode, e))
          : i && (i.d(1), (i = null))
      },
      d(n) {
        ;(n && (B(e), B(t)), i && i.d(n))
  ...
  function Qa(l) {
    let e,
      ...
      d = V(l[3]),
      o = []
    for (let m = 0; m < d.length; m += 1) o[m] = us(is(l, d, m))
    let I = l[2].length && Cs(l)
    return {
      c() {
        ;(A && A.c(),
          (e = Z()),
        ...
        ;((u = Z()),
          I && I.c(),
          _(a, 'class', 'pagefind-ui__result-link svelte-4xnkmf'),
          _(a, 'href', (n = l[1].meta?.url || l[1].url)),
          _(s, 'class', 'pagefind-ui__result-title svelte-4xnkmf'),
          _(t, 'class', 'pagefind-ui__result-inner svelte-4xnkmf'))
      },
      m(m, f) {
        ;(A && A.m(m, f),
          ...
          c && c.m(t, null),
          b(t, C))
        for (let p = 0; p < o.length; p += 1) o[p] && o[p].m(t, null)
        ;(b(t, u), I && I.m(t, null))
      },
      p(m, f) {
        if (
          (m[0]
            ? A
              ? A.p(m, f)
              : ((A = gs(m)), A.c(), A.m(e.parentNode, e))
            : A && (A.d(1), (A = null)),
          f & 2 && r !== (r = m[1].meta?.title + '') && W(i, r),
          f & 2 && n !== (n = m[1].meta?.url || m[1].url) && _(a, 'href', n),
          m[4]
            ? c
              ? c.p(m, f)
              : ((c = cs(m)), c.c(), c.m(t, C))
          ...
          for (p = 0; p < d.length; p += 1) {
            let U = is(m, d, p)
            o[p] ? o[p].p(U, f) : ((o[p] = us(U)), o[p].c(), o[p].m(t, u))
          }
        ...
        m[2].length
          ? I
            ? I.p(m, f)
            : ((I = Cs(m)), I.c(), I.m(t, null))
          : I && (I.d(1), (I = null))
      },
      d(m) {
        ;(m && (B(e), B(t)), A && A.d(m), c && c.d(), $(o, m), I && I.d())
      },
    }
  }
  function ns(l) {
  ...
  function gs(l) {
    let e,
      t = l[1].meta.image && os(l)
    return {
      c() {
        ;((e = F('div')),
          t && t.c(),
          _(e, 'class', 'pagefind-ui__result-thumb svelte-4xnkmf'))
      },
      m(s, a) {
        ;(h(s, e, a), t && t.m(e, null))
      },
  ...
  function os(l) {
    ...
    return {
      c() {
        ;((e = F('img')),
          _(e, 'class', 'pagefind-ui__result-image svelte-4xnkmf'),
          ge(e.src, (t = l[1].meta?.image)) || _(e, 'src', t),
          _(e, 'alt', (s = l[1].meta?.image_alt || l[1].meta?.title)))
      },
      m(a, r) {
  ...
  function cs(l) {
    ...
    return {
      c() {
        ;((e = F('p')),
          _(e, 'class', 'pagefind-ui__result-excerpt svelte-4xnkmf'))
      },
      m(s, a) {
        ;(h(s, e, a), (e.innerHTML = t))
      },
      p(s, a) {
        a & 2 && t !== (t = s[1].excerpt + '') && (e.innerHTML = t)
      },
      d(s) {
        s && B(e)
      },
    ...
    return {
      c() {
        ;((e = F('div')),
          ...
          (n = Z()),
          (g = F('p')),
          _(s, 'class', 'pagefind-ui__result-link svelte-4xnkmf'),
          _(s, 'href', (i = l[15].url)),
          _(t, 'class', 'pagefind-ui__result-title svelte-4xnkmf'),
          _(g, 'class', 'pagefind-ui__result-excerpt svelte-4xnkmf'),
          _(e, 'class', 'pagefind-ui__result-nested svelte-4xnkmf'))
      },
      m(u, A) {
        ;(h(u, e, A),
          b(e, t),
      ...
      p(u, A) {
        ;(A & 8 && a !== (a = u[15].title + '') && W(r, a),
          A & 8 && i !== (i = u[15].url) && _(s, 'href', i),
          A & 8 && C !== (C = u[15].excerpt + '') && (g.innerHTML = C))
      },
      d(u) {
        u && B(e)
      },
  ...
  function Cs(l) {
    let e,
      t = V(l[2]),
      s = []
    for (let a = 0; a < t.length; a += 1) s[a] = Is(rs(l, t, a))
    return {
      c() {
        e = F('ul')
        for (let a = 0; a < s.length; a += 1) s[a].c()
        _(e, 'class', 'pagefind-ui__result-tags svelte-4xnkmf')
      },
      m(a, r) {
        h(a, e, r)
        for (let i = 0; i < s.length; i += 1) s[i] && s[i].m(e, null)
      ...
      p(a, r) {
        if (r & 4) {
          ...
          for (i = 0; i < t.length; i += 1) {
            let n = rs(a, t, i)
            s[i] ? s[i].p(n, r) : ((s[i] = Is(n)), s[i].c(), s[i].m(e, null))
          }
          for (; i < s.length; i += 1) s[i].d(1)
          s.length = t.length
        }
    ...
    return {
      c() {
        ;((e = F('li')),
          ...
          (i = G(r)),
          (n = Z()),
          _(e, 'class', 'pagefind-ui__result-tag svelte-4xnkmf'),
          _(e, 'data-pagefind-ui-meta', (g = l[11])))
      },
      m(C, u) {
        ;(h(C, e, u), b(e, s), b(e, a), b(e, i), b(e, n))
      },
      p(C, u) {
        ;(u & 4 && t !== (t = C[11].replace(/^(\w)/, ds) + '') && W(s, t),
          u & 4 && r !== (r = C[12] + '') && W(i, r),
          u & 4 && g !== (g = C[11]) && _(e, 'data-pagefind-ui-meta', g))
      },
      d(C) {
        C && B(e)
      },
  ...
  function ma(l) {
    ...
    return {
      c() {
        ;((e = F('li')),
          a.c(),
          _(e, 'class', 'pagefind-ui__result svelte-4xnkmf'))
      },
      m(r, i) {
        ;(h(r, e, i), a.m(e, null))
      },
  ...
  function ba(l, e, t) {
    let { show_images: s = !0 } = e,
      ...
      A = (o, I) => {
        ...
        let m = [...o]
          .sort((f, p) => p.locations.length - f.locations.length)
          .slice(0, 3)
          .map(f => f.url)
      ...
      c = async o => {
        ;(t(1, (n = await o.data())),
          t(1, (n = a?.(n) ?? n)),
          t(2, (g = Object.entries(n.meta).filter(([I]) => !i.includes(I)))),
          Array.isArray(n.sub_results) &&
            (t(4, (u = n.sub_results?.[0]?.url === (n.meta?.url || n.url))),
            u
              ? t(3, (C = A(n.sub_results.slice(1), 3)))
              : t(3, (C = A([...n.sub_results], 3)))))
      },
      d = (o = 30) => '. '.repeat(Math.floor(10 + Math.random() * o))
    return (
      (l.$$set = o => {
        ;('show_images' in o && t(0, (s = o.show_images)),
          'process_result' in o && t(6, (a = o.process_result)),
          'result' in o && t(7, (r = o.result)))
      }),
      (l.$$.update = () => {
        l.$$.dirty & 128 && c(r)
      }),
  ...
  function ms(l) {
    let e,
      t,
      s = l[4]('filters_label', l[5], l[6]) + '',
      a,
      r,
      i = V(Object.entries(l[1])),
      n = []
    for (let g = 0; g < i.length; g += 1) n[g] = Fs(_s(l, i, g))
    return {
      c() {
        ;((e = F('fieldset')), (t = F('legend')), (a = G(s)), (r = Z()))
        for (let g = 0; g < n.length; g += 1) n[g].c()
        ;(_(t, 'class', 'pagefind-ui__filter-panel-label svelte-1v2r7ls'),
          _(e, 'class', 'pagefind-ui__filter-panel svelte-1v2r7ls'))
      },
      m(g, C) {
        ;(h(g, e, C), b(e, t), b(t, a), b(e, r))
        for (let u = 0; u < n.length; u += 1) n[u] && n[u].m(e, null)
      },
      p(g, C) {
        if (
          (C & 112 &&
            s !== (s = g[4]('filters_label', g[5], g[6]) + '') &&
            W(a, s),
          C & 143)
        ) {
          i = V(Object.entries(g[1]))
          let u
          for (u = 0; u < i.length; u += 1) {
            let A = _s(g, i, u)
            n[u] ? n[u].p(A, C) : ((n[u] = Fs(A)), n[u].c(), n[u].m(e, null))
          }
    ...
    return {
      c() {
        ;((e = F('div')),
          ...
          (d = G(')')),
          (I = Z()),
          _(t, 'class', 'pagefind-ui__filter-checkbox svelte-1v2r7ls'),
          _(t, 'type', 'checkbox'),
          _(t, 'id', (s = l[10] + '-' + l[14])),
          _(t, 'name', (a = l[10])),
          (t.__value = r = l[14]),
          oe(t, t.__value),
          (g.a = u),
          _(n, 'class', 'pagefind-ui__filter-label svelte-1v2r7ls'),
          _(n, 'for', (o = l[10] + '-' + l[14])),
          _(e, 'class', 'pagefind-ui__filter-value svelte-1v2r7ls'),
          z(e, 'pagefind-ui__filter-value--checked', l[0][`${l[10]}:${l[14]}`]))
      },
      m(U, y) {
        ;(h(U, e, y),
          b(e, t),
          (t.checked = l[0][`${l[10]}:${l[14]}`]),
          b(e, i),
          b(e, n),
          g.m(C, n),
          b(n, u),
          ...
          b(n, d),
          b(e, I),
          m || ((f = w(t, 'change', p)), (m = !0)))
      },
      p(U, y) {
        ;((l = U),
          y & 2 && s !== (s = l[10] + '-' + l[14]) && _(t, 'id', s),
          y & 2 && a !== (a = l[10]) && _(t, 'name', a),
          y & 2 && r !== (r = l[14]) && ((t.__value = r), oe(t, t.__value)),
          y & 3 && (t.checked = l[0][`${l[10]}:${l[14]}`]),
          y & 2 && C !== (C = l[14] + '') && g.p(C),
          y & 2 && A !== (A = l[15] + '') && W(c, A),
          y & 2 && o !== (o = l[10] + '-' + l[14]) && _(n, 'for', o),
          y & 3 &&
            z(
              e,
  ...
  function Fs(l) {
    let e,
      ...
      C,
      u,
      A = V(Object.entries(l[11] || {})),
      c = []
    for (let d = 0; d < A.length; d += 1) c[d] = fs(Qs(l, A, d))
    return {
      c() {
        ;((e = F('details')),
          (t = F('summary')),
        ...
        ;((C = Z()),
          _(t, 'class', 'pagefind-ui__filter-name svelte-1v2r7ls'),
          _(i, 'class', 'pagefind-ui__filter-group-label svelte-1v2r7ls'),
          _(r, 'class', 'pagefind-ui__filter-group svelte-1v2r7ls'),
          _(e, 'class', 'pagefind-ui__filter-block svelte-1v2r7ls'),
          (e.open = u = l[7] || l[3].map(Bs).includes(l[10].toLowerCase())))
      },
      m(d, o) {
        ;(h(d, e, o),
          b(e, t),
          ...
          (i.innerHTML = n),
          b(r, g))
        for (let I = 0; I < c.length; I += 1) c[I] && c[I].m(r, null)
        b(e, C)
      },
      p(d, o) {
        if (
          (o & 2 &&
            s !== (s = d[10].replace(/^(\w)/, ps) + '') &&
            (t.innerHTML = s),
          o & 2 && n !== (n = d[10] + '') && (i.innerHTML = n),
          o & 7)
        ) {
          A = V(Object.entries(d[11] || {}))
          let I
          for (I = 0; I < A.length; I += 1) {
            let m = Qs(d, A, I)
            c[I] ? c[I].p(m, o) : ((c[I] = fs(m)), c[I].c(), c[I].m(r, null))
          }
          for (; I < c.length; I += 1) c[I].d(1)
          c.length = A.length
        }
        o & 138 &&
          u !== (u = d[7] || d[3].map(Bs).includes(d[10].toLowerCase())) &&
          (e.open = u)
      },
      d(d) {
        ;(d && B(e), $(c, d))
  ...
  function fa(l) {
    let e = l[1] && Object.entries(l[1]).length,
      t,
      s = e && ms(l)
    return {
      c() {
      ...
      p(a, [r]) {
        ;(r & 2 && (e = a[1] && Object.entries(a[1]).length),
          e
            ? s
              ? s.p(a, r)
              : ((s = ms(a)), s.c(), s.m(t.parentNode, t))
            : s && (s.d(1), (s = null)))
      },
      i: R,
      o: R,
    ...
    return (
      (l.$$set = d => {
        ;('available_filters' in d && t(1, (s = d.available_filters)),
          'show_empty_filters' in d && t(2, (a = d.show_empty_filters)),
          ...
          'translations' in d && t(6, (g = d.translations)),
  ...
  var pa = 'Jan Claasen <jan@cloudcannon.com>',
    Ba = '',
    ha = 'ltr',
    Ua = {
      placeholder: 'Soek',
    ...
    xa = { thanks_to: pa, comments: Ba, direction: ha, strings: Ua }
  var St = {}
  x(St, {
    comments: () => Za,
    default: () => Xa,
  ...
  var ya = 'Jermanuts',
    ...
    Xa = { thanks_to: ya, comments: Za, direction: Ga, strings: Na }
  var Vt = {}
  x(Vt, {
    comments: () => ka,
    default: () => Wa,
  ...
  var Ea = 'Maruf Alom <mail@marufalom.com>',
    ka = '',
    La = 'ltr',
    Ra = {
      placeholder:
    ...
    Wa = { thanks_to: Ea, comments: ka, direction: La, strings: Ra }
  var Dt = {}
  x(Dt, {
    comments: () => Va,
    default: () => va,
  ...
  var Sa = 'Pablo Villaverde <https://github.com/pvillaverde>',
    Va = '',
    Da = 'ltr',
    Ta = {
      placeholder: 'Cerca',
    ...
    va = { thanks_to: Sa, comments: Va, direction: Da, strings: Ta }
  var Tt = {}
  x(Tt, {
    comments: () => Ma,
    default: () => za,
  ...
  var Ha = 'Dalibor Hon <https://github.com/dallyh>',
    Ma = '',
    Ya = 'ltr',
    wa = {
      placeholder: 'Hledat',
    ...
    za = { thanks_to: Ha, comments: Ma, direction: Ya, strings: wa }
  var vt = {}
  x(vt, {
    comments: () => Oa,
    default: () => Pa,
  ...
  var Ja = 'Jonas Smedegaard <dr@jones.dk>',
    Oa = '',
    ja = 'ltr',
    Ka = {
      placeholder: 'S\xF8g',
    ...
    Pa = { thanks_to: Ja, comments: Oa, direction: ja, strings: Ka }
  var Ht = {}
  x(Ht, {
    comments: () => $a,
    default: () => lr,
  ...
  var qa = 'Jan Claasen <jan@cloudcannon.com>',
    $a = '',
    er = 'ltr',
    tr = {
      placeholder: 'Suche',
    ...
    lr = { thanks_to: qa, comments: $a, direction: er, strings: tr }
  var Mt = {}
  x(Mt, {
    comments: () => ar,
    default: () => nr,
  ...
  var sr = 'George Papadopoulos',
    ...
    nr = { thanks_to: sr, comments: ar, direction: rr, strings: ir }
  var Yt = {}
  x(Yt, {
    comments: () => or,
    default: () => Cr,
  ...
  var gr = 'Liam Bigelow <liam@cloudcannon.com>',
    or = '',
    cr = 'ltr',
    ur = {
      placeholder: 'Search',
    ...
    Cr = { thanks_to: gr, comments: or, direction: cr, strings: ur }
  var wt = {}
  x(wt, {
    comments: () => dr,
    default: () => Qr,
  ...
  var Ir = 'Pablo Villaverde <https://github.com/pvillaverde>',
    dr = '',
    Ar = 'ltr',
    _r = {
      placeholder: 'Buscar',
    ...
    Qr = { thanks_to: Ir, comments: dr, direction: Ar, strings: _r }
  var zt = {}
  x(zt, {
    comments: () => br,
    default: () => pr,
  ...
  var mr = 'Mikel Larreategi <mlarreaegi@codesyntax.com>',
    br = '',
    fr = 'ltr',
    Fr = {
      placeholder: 'Bilatu',
    ...
    pr = { thanks_to: mr, comments: br, direction: fr, strings: Fr }
  var Jt = {}
  x(Jt, {
    comments: () => hr,
    default: () => yr,
  ...
  var Br = 'Ali Khaleqi Yekta <https://yekta.dev>',
    hr = '',
    Ur = 'rtl',
    xr = {
      placeholder: '\u062C\u0633\u062A\u062C\u0648',
    ...
    yr = { thanks_to: Br, comments: hr, direction: Ur, strings: xr }
  var Ot = {}
  x(Ot, {
    comments: () => Gr,
    default: () => Er,
  ...
  var Zr = 'Valtteri Laitinen <dev@valtlai.fi>',
    Gr = '',
    Nr = 'ltr',
    Xr = {
      placeholder: 'Haku',
    ...
    Er = { thanks_to: Zr, comments: Gr, direction: Nr, strings: Xr }
  var jt = {}
  x(jt, {
    comments: () => Lr,
    default: () => Sr,
  ...
  var kr = 'Nicolas Friedli <nicolas@theologique.ch>',
    Lr = '',
    Rr = 'ltr',
    Wr = {
    ...
    Sr = { thanks_to: kr, comments: Lr, direction: Rr, strings: Wr }
  var Kt = {}
  x(Kt, {
    comments: () => Dr,
    default: () => Hr,
  ...
  var Vr = 'Pablo Villaverde <https://github.com/pvillaverde>',
    Dr = '',
    Tr = 'ltr',
    vr = {
      placeholder: 'Buscar',
    ...
    Hr = { thanks_to: Vr, comments: Dr, direction: Tr, strings: vr }
  var Pt = {}
  x(Pt, {
    comments: () => Yr,
    default: () => Jr,
  ...
  var Mr = 'Nir Tamir <nirtamir2@gmail.com>',
    Yr = '',
    wr = 'rtl',
    zr = {
      placeholder: '\u05D7\u05D9\u05E4\u05D5\u05E9',
    ...
    Jr = { thanks_to: Mr, comments: Yr, direction: wr, strings: zr }
  var qt = {}
  x(qt, {
    comments: () => jr,
    default: () => qr,
  ...
  var Or = 'Amit Yadav <amit@thetechbasket.com>',
    jr = '',
    Kr = 'ltr',
    Pr = {
      placeholder: '\u0916\u094B\u091C\u0947\u0902',
    ...
    qr = { thanks_to: Or, comments: jr, direction: Kr, strings: Pr }
  var $t = {}
  x($t, {
    comments: () => ei,
    default: () => si,
  ...
  var $r = 'Diomed <https://github.com/diomed>',
    ei = '',
    ti = 'ltr',
    li = {
      placeholder: 'Tra\u017Ei',
    ...
    si = { thanks_to: $r, comments: ei, direction: ti, strings: li }
  var el = {}
  x(el, {
    comments: () => ri,
    default: () => gi,
  ...
  var ai = 'Adam Laki <info@adamlaki.com>',
    ri = '',
    ii = 'ltr',
    ni = {
    ...
    gi = { thanks_to: ai, comments: ri, direction: ii, strings: ni }
  var tl = {}
  x(tl, {
    comments: () => ci,
    default: () => Ii,
  ...
  var oi = 'Nixentric',
    ...
    Ii = { thanks_to: oi, comments: ci, direction: ui, strings: Ci }
  var ll = {}
  x(ll, {
    comments: () => Ai,
    default: () => mi,
  ...
  var di = 'Cosette Bruhns Alonso, Andrew Janco <apjanco@upenn.edu>',
    Ai = '',
    _i = 'ltr',
    Qi = {
      placeholder: 'Cerca',
    ...
    mi = { thanks_to: di, comments: Ai, direction: _i, strings: Qi }
  var sl = {}
  x(sl, {
    comments: () => fi,
    default: () => Bi,
  ...
  var bi = 'Tate',
    ...
    Bi = { thanks_to: bi, comments: fi, direction: Fi, strings: pi }
  var al = {}
  x(al, {
    comments: () => Ui,
    default: () => Zi,
  ...
  var hi = 'Seokho Son <https://github.com/seokho-son>',
    Ui = '',
    xi = 'ltr',
    yi = {
      placeholder: '\uAC80\uC0C9\uC5B4',
    ...
    Zi = { thanks_to: hi, comments: Ui, direction: xi, strings: yi }
  var rl = {}
  x(rl, {
    comments: () => Ni,
    default: () => ki,
  ...
  var Gi = '',
    ...
    ki = { thanks_to: Gi, comments: Ni, direction: Xi, strings: Ei }
  var il = {}
  x(il, {
    comments: () => Ri,
    default: () => Vi,
  ...
  var Li = 'Harry Min Khant <https://harrymkt.github.io>',
    Ri = '',
    Wi = 'ltr',
    Si = {
      placeholder: '\u101B\u103E\u102C\u101B\u1014\u103A',
    ...
    Vi = { thanks_to: Li, comments: Ri, direction: Wi, strings: Si }
  var nl = {}
  x(nl, {
    comments: () => Ti,
    default: () => Mi,
  ...
  var Di = 'Eirik Mikkelsen',
    ...
    Mi = { thanks_to: Di, comments: Ti, direction: vi, strings: Hi }
  var gl = {}
  x(gl, {
    comments: () => wi,
    default: () => Oi,
  ...
  var Yi = 'Paul van Brouwershaven',
    ...
    Oi = { thanks_to: Yi, comments: wi, direction: zi, strings: Ji }
  var ol = {}
  x(ol, {
    comments: () => Ki,
    default: () => $i,
  ...
  var ji = 'Eirik Mikkelsen',
    ...
    $i = { thanks_to: ji, comments: Ki, direction: Pi, strings: qi }
  var cl = {}
  x(cl, {
    comments: () => tn,
    default: () => an,
  ...
  var en = 'Christopher Wingate',
    ...
    an = { thanks_to: en, comments: tn, direction: ln, strings: sn }
  var ul = {}
  x(ul, {
    comments: () => nn,
    default: () => cn,
  ...
  var rn = '',
    ...
    cn = { thanks_to: rn, comments: nn, direction: gn, strings: on }
  var Cl = {}
  x(Cl, {
    comments: () => Cn,
    default: () => An,
  ...
  var un = 'Jonatah',
    ...
    An = { thanks_to: un, comments: Cn, direction: In, strings: dn }
  var Il = {}
  x(Il, {
    comments: () => Qn,
    default: () => fn,
  ...
  var _n = 'Bogdan Mateescu <bogdan@surfverse.com>',
    Qn = '',
    mn = 'ltr',
    bn = {
      placeholder: 'C\u0103utare',
    ...
    fn = { thanks_to: _n, comments: Qn, direction: mn, strings: bn }
  var dl = {}
  x(dl, {
    comments: () => pn,
    default: () => Un,
  ...
  var Fn = 'Aleksandr Gordeev',
    ...
    Un = { thanks_to: Fn, comments: pn, direction: Bn, strings: hn }
  var Al = {}
  x(Al, {
    comments: () => yn,
    default: () => Nn,
  ...
  var xn = 'Andrija Sagicc',
    ...
    Nn = { thanks_to: xn, comments: yn, direction: Zn, strings: Gn }
  var _l = {}
  x(_l, {
    comments: () => En,
    default: () => Rn,
  ...
  var Xn = 'Montazar Al-Jaber <montazar@nanawee.tech>',
    En = '',
    kn = 'ltr',
    Ln = {
      placeholder: 'S\xF6k',
    ...
    Rn = { thanks_to: Xn, comments: En, direction: kn, strings: Ln }
  var Ql = {}
  x(Ql, {
    comments: () => Sn,
    default: () => Tn,
  ...
  var Wn = 'Anonymous',
    ...
    Tn = { thanks_to: Wn, comments: Sn, direction: Vn, strings: Dn }
  var ml = {}
  x(ml, {
    comments: () => Hn,
    default: () => wn,
  ...
  var vn = '',
    ...
    wn = { thanks_to: vn, comments: Hn, direction: Mn, strings: Yn }
  var bl = {}
  x(bl, {
    comments: () => Jn,
    default: () => Kn,
  ...
  var zn = 'Patiphon Loetsuthakun <ptphon@gmail.com>',
    Jn = '',
    On = 'ltr',
    jn = {
      placeholder: '\u0E04\u0E49\u0E19\u0E2B\u0E32',
    ...
    Kn = { thanks_to: zn, comments: Jn, direction: On, strings: jn }
  var fl = {}
  x(fl, {
    comments: () => qn,
    default: () => tg,
  ...
  var Pn = 'Taylan \xD6zg\xFCr Bildik',
    ...
    tg = { thanks_to: Pn, comments: qn, direction: $n, strings: eg }
  var Fl = {}
  x(Fl, {
    comments: () => sg,
    default: () => ig,
  ...
  var lg = 'Vladyslav Lyshenko <vladdnepr1989@gmail.com>',
    sg = '',
    ag = 'ltr',
    rg = {
      placeholder: '\u041F\u043E\u0448\u0443\u043A',
    ...
    ig = { thanks_to: lg, comments: sg, direction: ag, strings: rg }
  var pl = {}
  x(pl, {
    comments: () => gg,
    default: () => ug,
  ...
  var ng = 'Long Nhat Nguyen',
    ...
    ug = { thanks_to: ng, comments: gg, direction: og, strings: cg }
  var Bl = {}
  x(Bl, {
    comments: () => Ig,
    default: () => _g,
  ...
  var Cg = 'Amber Song',
    ...
    _g = { thanks_to: Cg, comments: Ig, direction: dg, strings: Ag }
  var hl = {}
  x(hl, {
    comments: () => mg,
    default: () => Fg,
  ...
  var Qg = 'Amber Song',
    ...
    Fg = { thanks_to: Qg, comments: mg, direction: bg, strings: fg }
  var Ul = {}
  x(Ul, {
    comments: () => Bg,
    default: () => xg,
  ...
  var pg = 'Amber Song',
    ...
    xg = { thanks_to: pg, comments: Bg, direction: hg, strings: Ug }
  var yg = [
      Wt,
      St,
      Vt,
  ...
  function Zs(l) {
    ...
    let r = {
      show_empty_filters: l[5],
      open_filters: l[6],
      available_filters: l[18],
      translate: l[20],
      automatic_translations: l[19],
      translations: l[7],
    }
    return (
      l[0] !== void 0 && (r.selected_filters = l[0]),
      (e = new hs({ props: r })),
      Ce.push(() => Ol(e, 'selected_filters', a)),
      {
        c() {
          _t(e.$$.fragment)
        },
        ...
        p(i, n) {
          let g = {}
          ;(n[0] & 32 && (g.show_empty_filters = i[5]),
            n[0] & 64 && (g.open_filters = i[6]),
            n[0] & 262144 && (g.available_filters = i[18]),
            n[0] & 524288 && (g.automatic_translations = i[19]),
            n[0] & 128 && (g.translations = i[7]),
            !t &&
              n[0] & 1 &&
              ((t = !0), (g.selected_filters = i[0]), Yl(() => (t = !1))),
            e.$set(g))
        },
        i(i) {
          s || (k(e.$$.fragment, i), (s = !0))
        },
        o(i) {
          ;(D(e.$$.fragment, i), (s = !1))
        },
    ...
    return (
      ...
      (s = i[t] = r[t](l)),
      {
        c() {
          ;((e = F('div')),
            s.c(),
            _(e, 'class', 'pagefind-ui__results-area svelte-e9gkc3'))
        },
        m(g, C) {
          ;(h(g, e, C), i[t].m(e, null), (a = !0))
        },
        p(g, C) {
          let u = t
          ;((t = n(g, C)),
  ...
  function Gg(l) {
    let e,
      ...
      g
    function C(I, m) {
      return I[13].results.length === 0
        ? kg
        : I[13].results.length === 1
          ? Eg
          : Xg
    }
    let u = C(l, [-1, -1]),
      A = u(l),
      c = V(l[13].results.slice(0, l[17])),
      d = I => I[53].id
    ...
    let o = l[13].results.length > l[17] && Xs(l)
    return {
      c() {
        ;((e = F('p')), A.c(), (t = Z()), (s = F('ol')))
        for (let I = 0; I < a.length; I += 1) a[I].c()
        ;((i = Z()),
          o && o.c(),
          (n = ee()),
          _(e, 'class', 'pagefind-ui__message svelte-e9gkc3'),
          _(s, 'class', 'pagefind-ui__results svelte-e9gkc3'))
      },
      m(I, m) {
        ;(h(I, e, m), A.m(e, null), h(I, t, m), h(I, s, m))
        for (let f = 0; f < a.length; f += 1) a[f] && a[f].m(s, null)
        ;(h(I, i, m), o && o.m(I, m), h(I, n, m), (g = !0))
      },
      p(I, m) {
        ;(u === (u = C(I, m)) && A
          ? A.p(I, m)
          : (A.d(1), (A = u(I)), A && (A.c(), A.m(e, null))),
          m[0] & 139292 &&
            ((c = V(I[13].results.slice(0, I[17]))),
            re(),
            (a = Jl(a, m, d, 1, I, c, r, s, zl, Ns, null, ys)),
            ie()),
          I[13].results.length > I[17]
            ? o
              ? o.p(I, m)
              : ((o = Xs(I)), o.c(), o.m(n.parentNode, n))
            : o && (o.d(1), (o = null)))
      },
      i(I) {
        if (!g) {
          for (let m = 0; m < c.length; m += 1) k(a[m])
          g = !0
        }
      },
      o(I) {
        for (let m = 0; m < a.length; m += 1) D(a[m])
        g = !1
      },
      d(I) {
        ;(I && (B(e), B(t), B(s), B(i), B(n)), A.d())
  ...
  function Xg(l) {
    let e =
        l[20]('many_results', l[19], l[7])
          .replace(/\[SEARCH_TERM\]/, l[16])
          .replace(
            /\[COUNT\]/,
            new Intl.NumberFormat(l[7].language || l[19].language).format(
              l[13].results.length,
            ),
          ) + '',
      t
          ...
          e !==
            (e =
              s[20]('many_results', s[19], s[7])
                ...
                .replace(
                  /\[COUNT\]/,
                  new Intl.NumberFormat(s[7].language || s[19].language).format(
                    s[13].results.length,
                  ),
                ) + '') &&
          W(t, e)
  ...
  function Eg(l) {
    let e =
        l[20]('one_result', l[19], l[7])
          .replace(/\[SEARCH_TERM\]/, l[16])
          .replace(
            /\[COUNT\]/,
            new Intl.NumberFormat(l[7].language || l[19].language).format(1),
          ) + '',
      t
    return {
      c() {
  ...
  function kg(l) {
    let e =
        l[20]('zero_results', l[19], l[7]).replace(/\[SEARCH_TERM\]/, l[16]) +
        '',
      t
    return {
      c() {
  ...
  function Lg(l) {
    ...
    return (
      (e = new as({
        props: { show_images: l[2], process_result: l[4], result: l[53] },
      })),
      {
        c() {
          _t(e.$$.fragment)
        ...
        p(s, a) {
          let r = {}
          ;(a[0] & 4 && (r.show_images = s[2]),
            a[0] & 16 && (r.process_result = s[4]),
            a[0] & 139264 && (r.result = s[53]),
            e.$set(r))
        },
        i(s) {
  ...
  function Ns(l, e) {
    ...
    return (
      ...
      (a = g[s] = n[s](e)),
      {
        ...
        first: null,
        c() {
          ;((t = ee()), a.c(), (r = ee()), (this.first = t))
        },
        m(u, A) {
          ;(h(u, t, A), g[s].m(u, A), h(u, r, A), (i = !0))
        },
        p(u, A) {
          e = u
          let c = s
    ...
    return {
      c() {
        ;((e = F('button')),
          (s = G(t)),
          _(e, 'type', 'button'),
          _(e, 'class', 'pagefind-ui__button svelte-e9gkc3'))
      },
      m(i, n) {
        ;(h(i, e, n), b(e, s), a || ((r = w(e, 'click', l[22])), (a = !0)))
      },
      p(i, n) {
        n[0] & 524416 &&
  ...
  function Es(l) {
    let e,
      t =
        l[20]('searching', l[19], l[7]).replace(/\[SEARCH_TERM\]/, l[16]) + '',
      s
    return {
      c() {
        ;((e = F('p')),
      ...
      p(a, r) {
        r[0] & 589952 &&
          t !==
            (t =
              a[20]('searching', a[19], a[7]).replace(
                /\[SEARCH_TERM\]/,
                a[16],
              ) + '') &&
          W(s, t)
    ...
    return {
      c() {
        ;((e = F('div')),
          ...
          (c = Z()),
          p && p.c(),
          _(s, 'class', 'pagefind-ui__search-input svelte-e9gkc3'),
          _(s, 'type', 'text'),
          _(s, 'placeholder', (a = l[20]('placeholder', l[19], l[7]))),
          _(s, 'title', (r = l[20]('placeholder', l[19], l[7]))),
          _(s, 'autocapitalize', 'none'),
          _(s, 'enterkeyhint', 'search'),
          (s.autofocus = l[8]),
          _(n, 'class', 'pagefind-ui__search-clear svelte-e9gkc3'),
          z(n, 'pagefind-ui__suppressed', !l[9]),
          _(A, 'class', 'pagefind-ui__drawer svelte-e9gkc3'),
          z(A, 'pagefind-ui__hidden', !l[15]),
          _(t, 'class', 'pagefind-ui__form svelte-e9gkc3'),
          _(t, 'role', 'search'),
          _(t, 'aria-label', (d = l[20]('search_label', l[19], l[7]))),
          _(t, 'action', 'javascript:void(0);'),
          _(e, 'class', 'pagefind-ui svelte-e9gkc3'),
          z(e, 'pagefind-ui--reset', l[1]))
      },
      m(U, y) {
        ;(h(U, e, y),
          b(e, t),
      ...
      p(U, y) {
        ;((!o ||
          (y[0] & 524416 && a !== (a = U[20]('placeholder', U[19], U[7])))) &&
          _(s, 'placeholder', a),
          (!o ||
            (y[0] & 524416 && r !== (r = U[20]('placeholder', U[19], U[7])))) &&
            _(s, 'title', r),
          (!o || y[0] & 256) && (s.autofocus = U[8]),
          y[0] & 512 && s.value !== U[9] && oe(s, U[9]),
          (!o || y[0] & 524416) &&
            g !== (g = U[20]('clear_search', U[19], U[7]) + '') &&
            W(C, g),
          (!o || y[0] & 512) && z(n, 'pagefind-ui__suppressed', !U[9]),
          U[12]
            ? f
              ? (f.p(U, y), y[0] & 4096 && k(f, 1))
              : ((f = Zs(U)), f.c(), k(f, 1), f.m(A, c))
            : f &&
              (re(),
              D(f, 1, 1, () => {
                f = null
          ...
          U[15]
            ? p
              ? (p.p(U, y), y[0] & 32768 && k(p, 1))
              : ((p = Gs(U)), p.c(), k(p, 1), p.m(A, null))
            : p &&
              (re(),
              D(p, 1, 1, () => {
                p = null
              ...
              ie()),
          (!o || y[0] & 32768) && z(A, 'pagefind-ui__hidden', !U[15]),
          (!o ||
            (y[0] & 524416 &&
              d !== (d = U[20]('search_label', U[19], U[7])))) &&
            _(t, 'aria-label', d),
          (!o || y[0] & 2) && z(e, 'pagefind-ui--reset', U[1]))
      },
      i(U) {
        o || (k(f), k(p), (o = !0))
      },
  ...
  var Sg = l => l.preventDefault()
  function Vg(l, e, t) {
    let s = {},
      a = xs.map(Q => Q.match(/([^\/]+)\.json$/)[1])
    for (let Q = 0; Q < a.length; Q++)
      s[a[Q]] = { language: a[Q], ...Us[Q].strings }
    let { base_path: r = '/pagefind/' } = e,
      ...
      { open_filters: o = [] } = e,
      { debounce_timeout_ms: I = 300 } = e,
      { pagefind_options: m = {} } = e,
      { merge_index: f = [] } = e,
      { trigger_search_term: p = '' } = e,
      { translations: U = {} } = e,
      { autofocus: y = !1 } = e,
      { focus_on_slash: q = !1 } = e,
      { sort: J = null } = e,
      { selected_filters: N = {} } = e,
      S = '',
      E,
      v,
      gt,
        ...
        let X = document.activeElement,
          L =
            ...
            (X.tagName === 'INPUT' ||
              X.tagName === 'TEXTAREA' ||
              X.isContentEditable)
        Q.key === '/' && !L && (Q.preventDefault(), v?.focus())
      }
    ;(xt(() => {
      let Q = document?.querySelector?.('html')?.getAttribute?.('lang') || 'en',
        X = Qt(Q.toLocaleLowerCase())
      ;(t(
        19,
        (El =
          s[`${X.language}-${X.script}-${X.region}`] ||
          s[`${X.language}-${X.region}`] ||
          s[`${X.language}`] ||
          s.en),
      ),
        q && document.addEventListener('keydown', kl))
    }),
      yt(() => {
        ;(E?.destroy?.(),
          (E = null),
          q && document.removeEventListener('keydown', kl))
      }))
    let Ll = async () => {
        if (!bt && (t(12, (bt = !0)), !E)) {
          let Q
          try {
            Q = await import(`${r}pagefind.js`)
          } catch (L) {
            ;(console.error(L),
              console.error(
                [
...
`),
          ...
          u || t(24, (u = C ? 12 : 30))
          let X = { ...(m || {}), excerptLength: u }
          await Q.options(X)
          for (let L of f) {
            if (!L.bundlePath)
              throw new Error('mergeIndex requires a bundlePath parameter')
            let Y = L.bundlePath
            ;(delete L.bundlePath, await Q.mergeIndex(Y, L))
          }
          ;((E = Q), Ws())
        }
      },
      Ws = async () => {
        E &&
          ((Xl = await E.filters()),
          (!Ie || !Object.keys(Ie).length) && t(18, (Ie = Xl)))
      },
      Ss = Q => {
        let X = {}
        return (
      ...
      Ds = async (Q, X) => {
        ;(t(16, (Nl = Q || '')),
          typeof c == 'function' && (Q = c(Q)),
          t(14, (ft = !0)),
          t(15, (Ft = !0)),
          await Rl())
        let L = ++Gl,
          Y = { filters: X }
        J && typeof J == 'object' && (Y.sort = J)
        let ne = await E.search(Q, Y)
        Gl === L &&
          (ne.filters &&
            Object.keys(ne.filters)?.length &&
            t(18, (Ie = ne.filters)),
          t(13, (Zl = ne)),
          t(14, (ft = !1)),
          t(17, (pt = i)))
      ...
      Ts = () => {
        let Q = gt.offsetWidth
        Q != Ls && t(10, (v.style.paddingRight = `${Q + 2}px`), v)
      },
      vs = Q => {
        ;(Q?.preventDefault(), t(17, (pt += i)))
      },
      Hs = Q => {
        ;(Q.key === 'Escape' && (t(9, (S = '')), v.blur()),
          Q.key === 'Enter' && Q.preventDefault())
      }
    function Ms() {
      ;((S = this.value), t(9, S), t(23, p))
    }
    function Ys(Q) {
      Ce[Q ? 'unshift' : 'push'](() => {
        ;((v = Q), t(10, v))
    ...
    return (
      (l.$$set = Q => {
        ;('base_path' in Q && t(25, (r = Q.base_path)),
          'page_size' in Q && t(26, (i = Q.page_size)),
          'reset_styles' in Q && t(1, (n = Q.reset_styles)),
          'show_images' in Q && t(2, (g = Q.show_images)),
          'show_sub_results' in Q && t(3, (C = Q.show_sub_results)),
          'excerpt_length' in Q && t(24, (u = Q.excerpt_length)),
          'process_result' in Q && t(4, (A = Q.process_result)),
          'process_term' in Q && t(27, (c = Q.process_term)),
          'show_empty_filters' in Q && t(5, (d = Q.show_empty_filters)),
          'open_filters' in Q && t(6, (o = Q.open_filters)),
          'debounce_timeout_ms' in Q && t(28, (I = Q.debounce_timeout_ms)),
          'pagefind_options' in Q && t(29, (m = Q.pagefind_options)),
          'merge_index' in Q && t(30, (f = Q.merge_index)),
          'trigger_search_term' in Q && t(23, (p = Q.trigger_search_term)),
          'translations' in Q && t(7, (U = Q.translations)),
          'autofocus' in Q && t(8, (y = Q.autofocus)),
          'focus_on_slash' in Q && t(31, (q = Q.focus_on_slash)),
          'sort' in Q && t(32, (J = Q.sort)),
          'selected_filters' in Q && t(0, (N = Q.selected_filters)))
      }),
      (l.$$.update = () => {
        ;(l.$$.dirty[0] & 8388608 && p && (t(9, (S = p)), t(23, (p = ''))),
          l.$$.dirty[0] & 513 && Vs(S, N))
      }),
      [
        N,
        n,
  ...
  try {
    document?.currentScript &&
      document.currentScript.tagName.toUpperCase() === 'SCRIPT' &&
      (yl = new URL(document.currentScript.src).pathname.match(
        /^(.*\/)(?:pagefind-)?ui.js.*$/,
      )[1])
  } catch {
    yl = '/pagefind/'
  ...
  var mt = class {
    constructor(e) {
      ...
      let t = e.element ?? '[data-pagefind-ui]',
        ...
        r = e.resetStyles ?? !0,
        i = e.showImages ?? !0,
        n = e.showSubResults ?? !1,
        g = e.excerptLength ?? 0,
        C = e.processResult ?? null,
    ...
    triggerFilters(e) {
      ...
      for (let [s, a] of Object.entries(e))
        if (Array.isArray(a)) for (let r of a) t[`${s}:${r}`] = !0
        else t[`${s}:${a}`] = !0
