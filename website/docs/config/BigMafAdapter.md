...
| <span id="slot-nhlocation">**nhLocation**</span><br>[`fileLocation`](/docs/config_guides/slot_types#filelocation) = <code>{ uri: UNCONFIGURED_NH_URI, locationType: 'UriLocation' }</code> | newick tree |
