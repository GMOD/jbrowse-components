...
| <span id="slot-maxmissingnessfilter">**maxMissingnessFilter**</span><br>[`number`](/docs/config_guides/slot_types#number) = <code>1</code> | Hide variants whose fraction of uncalled alleles is above this threshold; 1 keeps every variant<br>_advanced_ |
