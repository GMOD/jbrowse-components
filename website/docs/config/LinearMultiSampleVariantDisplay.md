...
| <span id="slot-rowcolor">**rowColor**</span><br>[VariantRowColor](../variantrowcolor) | The tint beside each row's label: a sample-metadata attribute whose palette tints every row, and the colours a reader set row by row. |
