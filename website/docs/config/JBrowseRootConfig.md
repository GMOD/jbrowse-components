...
| <span id="slot-tracks">**tracks**</span><br><details><summary><code>types.frozen([] as { trackId: string; [key: string]: unknown }[…</code></summary><pre><code>types.frozen([] as { trackId: string; [key: string]: unknown }[])</code></pre></details> | track configuration is an array of track config schemas. multiple instances of a track can exist that use the same configuration. Always uses frozen for performance - editing creates temporary MST models. |
| <span id="slot-internetaccounts">**internetAccounts**</span><br><details><summary><code>types.array( pluginManager.pluggableConfigSchemaType('internet…</code></summary><pre><code>types.array(&#10;&#160;&#160;pluginManager.pluggableConfigSchemaType('internet account'),&#10;)</code></pre></details> | configuration for internet accounts, see InternetAccounts |
| <span id="slot-aggregatetextsearchadapters">**aggregateTextSearchAdapters**</span><br><details><summary><code>types.array( pluginManager.pluggableConfigSchemaType('text sear…</code></summary><pre><code>types.array(&#10;&#160;&#160;pluginManager.pluggableConfigSchemaType('text search adapter'),&#10;)</code></pre></details> | configuration for aggregate text search adapters (created by e.g. jbrowse text-index, but can be a pluggable TextSearchAdapter type) |
| <span id="slot-connections">**connections**</span><br><details><summary><code>types.array( pluginManager.pluggableConfigSchemaType('connectio…</code></summary><pre><code>types.array(&#10;&#160;&#160;pluginManager.pluggableConfigSchemaType('connection'),&#10;)</code></pre></details> | configuration for connections |
