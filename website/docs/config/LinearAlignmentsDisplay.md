...
| [heightMode](#slot-heightmode)                             | `stringEnum` (inherit, fit, fixed)                               | How read height is chosen. `inherit` (the default) follows the session-wide default for this display type, falling back to `fixed`; `fixed` uses `featureHeight`/`featureSpacing`; `fit` sizes reads so every uncollapsed group fills the display without scrolling              |
...
| [mismatchAlpha](#slot-mismatchalpha)                       | `boolean`                                                        | Fade mismatches by base quality                                                                                                                                                                                                                                                  |
...
| [showSoftClipping](#slot-showsoftclipping)                 | `boolean`                                                        | Draw soft-clipped read portions                                                                                                                                                                                                                                                  |
