...
| <span id="slot-marksfacetdomain">**marks.facet.domain**</span><br>`stringArray` = <code>[]</code> | The section order: the values listed stack first, in this order, and the rest follow sorted. A listed value the data lacks takes no section. |
