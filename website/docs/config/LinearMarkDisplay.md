...
| <span id="slot-scales">**scales**</span><br><span class="cell-more"><button type="button" class="cell-more-trigger"><code>scalesSchema( valueScaleSchema({ types: ['linear', 'log'], auto…</code></button><dialog class="cell-dialog"><form method="dialog"><button class="cell-dialog-close" aria-label="Close">✕</button></form><pre><code>scalesSchema(&#10;&#160;&#160;valueScaleSchema({&#10;&#160;&#160;&#160;&#160;types: ['linear', 'log'],&#10;&#160;&#160;&#160;&#160;autoscale: {&#10;&#160;&#160;&#160;&#160;&#160;&#160;modes: ['local', 'localsd', 'localpercentile'],&#10;&#160;&#160;&#160;&#160;&#160;&#160;default: 'local',&#10;&#160;&#160;&#160;&#160;},&#10;&#160;&#160;}),&#10;)</code></pre></dialog></span> | The scales the marks are read through, owned by the display rather than by a mark: `y` alone, and every mark's `encoding.y` shares it. The same object the wiggle family declares, with this display's own scale types — no symlog, which `valueToYPxScaled` does not place. |
