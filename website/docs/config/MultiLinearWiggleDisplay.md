...
| <span id="slot-domain">**domain**</span><br>`stringArray` = <code>[]</code> | Row order: the subtracks listed come first, in this order, and the rest keep the adapter's order |
