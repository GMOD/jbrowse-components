...
| <span id="slot-usebgzfworkerpool">**useBgzfWorkerPool**</span><br>[`boolean`](/docs/config_guides/slot_types#boolean) = <code>true</code> | inflate BGZF blocks on a pool of workers rather than in the thread that asked<br>_advanced_ |
