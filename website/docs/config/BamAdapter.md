...
| <span id="slot-index">**index**</span><br>[BamIndex](../bamindex) | where the BAM index is and which kind it is. The `uri` shorthand derives both, so a config using it states neither. |
