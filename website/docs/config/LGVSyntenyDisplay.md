...
| <span id="slot-linkedreads">**linkedReads**</span><br>[`maybeStringEnum`](/docs/config_guides/slot_types#the-maybe-types) (off, normal) = <code>'off'</code> _promotable_ | Linked-read (barcode-chain) layout mode |
