...
| <span class="slot-group">Inherited from [LinearAlignmentsDisplay](../linearalignmentsdisplay)</span> | <span class="slot-group-count">44 slots</span> |
...
| <span id="slot-showsplitjunctionarcs">**showSplitJunctionArcs**</span><br>[`maybeBoolean`](/docs/config_guides/slot_types#the-maybe-types) = <code>false</code> _promotable_ | Draw one counted arc per split-read junction, over the coverage band |
