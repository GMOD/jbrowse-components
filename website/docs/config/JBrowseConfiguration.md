...
| <span id="slot-configurationformatdetails">**configuration.formatDetails**</span><br><code>FormatDetailsConfigSchemaFactory()</code> | jexl callbacks that add or reformat fields shown in the feature details panel, see FormatDetails |
| <span id="slot-configurationformatabout">**configuration.formatAbout**</span><br><code>FormatAboutConfigSchemaFactory()</code> | jexl callbacks that add or reformat fields shown in a track's About dialog, see FormatAbout |
