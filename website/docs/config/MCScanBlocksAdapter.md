...
| <span id="slot-bedlocations">**bedLocations**</span><br>[`frozen`](/docs/config_guides/slot_types#frozen) = <code>[]</code> | one BED per column of the blocks file, as a path or a fileLocation, parallel to blockAssemblies, resolving that column's gene ids to coordinates |
