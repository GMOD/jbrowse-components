...
| [Large results](https://colab.research.google.com/github/GMOD/jbrowse-anywidget/blob/main/examples/12_large_data.ipynb)                               | When to write a file to disk instead of passing data to `features_track`                          |
