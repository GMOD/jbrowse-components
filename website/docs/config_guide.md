...
- [Configuring connections](/docs/config_guides/connections) - Connection config for UCSC/JB2 track hubs and JBrowse 1 data directories, and how connections are stored in config vs. the session
