...
description: Install JBrowse Web and build its config.json from the shell with @jbrowse/cli — create, add-assembly, add-track, text-index, and the rest
---
...
see [@jbrowse/img](/docs/jbrowse-img)
