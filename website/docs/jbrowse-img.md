...
description:
  Render publication-ready SVG or PNG of a JBrowse view from the command line,
...
<Figure src="/img/jbrowse-img/ecoli_ava_synteny.png" caption="Five E. coli strains stacked from one all-vs-all PAF, every band served by the same track" />
