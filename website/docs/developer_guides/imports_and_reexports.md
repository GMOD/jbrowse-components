...
| --- | --- | --- | --- |
| [`@jbrowse/core`](/docs/api/core) | JBrowse 2 core libraries used by plugins | 254 | 213 of 254 subpaths; the rest stubbed |
| `@jbrowse/display-kit` | The display integration layer a track type is built on: the fetch foundations, the byte gate, the display chrome, SVG export, and the RegionHost view contract | 83 | 63 of 83 subpaths; the rest stubbed |
