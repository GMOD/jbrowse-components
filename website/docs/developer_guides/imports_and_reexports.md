...
| --- | --- | --- | --- |
| [`@jbrowse/core`](/docs/api/core) | JBrowse 2 core libraries used by plugins | 245 | 205 of 245 subpaths; the rest stubbed |
| `@jbrowse/display-kit` | The display integration layer a track type is built on: the fetch foundations, the byte gate, the display chrome, SVG export, and the RegionHost view contract | 81 | 61 of 81 subpaths; the rest stubbed |
