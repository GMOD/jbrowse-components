...
There is also more examples and information in our user [advanced configuration guide](/docs/userguides/advanced/userguide_config_callbacks/).
...
You can also [write your own jexl function](/docs/devguides/devguide_pluggable_elements) and call it in the same way in the configuration.
