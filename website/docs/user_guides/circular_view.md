...
to the breakpoint split view — reach for it when you want to triage many
variants at once rather than plot a single track.

## See also

- [SV inspector view](/docs/user_guides/sv_inspector_view) — the circular
  overview paired with a searchable, filterable SV table
- [Structural variant visualization](/docs/user_guides/sv_visualization) —
  interpreting SV signals across arcs, colorings, and the breakpoint split view
- [Cancer SVs (C-GIAB) tutorial](/docs/tutorials/sv_visualization_cgiab) —
  end-to-end workflow on real tumor/normal data
- [ChordVariantDisplay config schema](/docs/config/chordvariantdisplay) — every
  display slot, autogenerated from source
- [Gallery: structural variant examples](/gallery/#sv) — the circular overview
  in context alongside breakpoint split views and other SV sessions
