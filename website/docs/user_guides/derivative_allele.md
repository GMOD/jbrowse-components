...
<Figure caption="Top: the reconstruction dialog over the COLO829 tumor pileup, each route's segments drawn to scale under its read count; the top route's junctions are validated calls. Bottom: the linear synteny view the top route opens, hg38 above and the reconstructed allele below." src="/img/cancer_sv/derivative_autogenerated.png" />
