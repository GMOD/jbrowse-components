...
and the band reads better than individual genes at that zoom, so the gene track
asks for it from 50 kb per pixel outward. The repeat tracks need no such nudge.
