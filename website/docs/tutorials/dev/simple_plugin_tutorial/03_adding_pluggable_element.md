...
For this tutorial, we're going to be creating a custom [widget](/docs/devguides/developer_guide/#widgets), and using a [Jexl](https://github.com/TomFrost/Jexl) callback to open it when we click a chord on the circular genome view.
...
Notice the use of [URL params](/docs/api_guide/#url-params) to speed up the test setup; using URL params like this can come in handy for larger suites.
