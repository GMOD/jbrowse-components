...
The segment track along the allele gives each piece its size. The last few draw
as hairline ribbons at the right-hand end because they are hairline segments,
and the reference row is crowded there for the same reason: its later loci are
narrow enough that their genes, and the gene track carried up from the launching
view, collide in those few pixels. The figure after this one opens those
junctions at base scale.
