...
<Figure caption="Unusually, both dog FGF4 retrocopies were Sanger sequenced and deposited (MF040222, MF040221), so each can be aligned back to the parent gene between them. Every gap in a ribbon is one of the parent's introns, and the blue Manta calls sit in the same two places." src="/img/dog10k-fgf4-retrogene-synteny.png" />
