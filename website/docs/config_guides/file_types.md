...
reader. Find your file format in the tables below for the adapter that reads it,
a config snippet, and a link to its full config docs. Most adapters accept the
[`uri` shorthand](#the-uri-shorthand).
