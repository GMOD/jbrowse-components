...
acid itself is drawn on each codon once you zoom in far enough to read it. Unlike
the per-base view, this answers "did the protein change here?" directly, across
every aligned species at once.
