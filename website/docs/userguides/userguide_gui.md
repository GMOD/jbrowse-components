...
- [JBrowse CLI](/docs/quickstarts/quickstart_cli/#installing-the-cli-tools)

- [JBrowse 2 web application](/docs/quickstarts/quickstart_cli/#using-jbrowse-create-to-download-jbrowse-2)
...
As an example, let's add the hg38 human reference genome to our JBrowse 2 application.
...
to refer to the [config guide](/docs/userguides/advanced/userguide_config_comp) for topics such as
[adding tracks](/docs/userguides/advanced/userguide_config_comp/#track-configurations) or
[adding an assembly with the CLI](/docs/userguides/advanced/userguide_config_comp/#adding-an-assembly-with-the-cli).
