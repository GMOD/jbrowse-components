...
- [Pluggable elements](/docs/developer_guides/pluggable_elements) - reference
  list of every element type a plugin can register
...
- [Customizing the Add Track workflow](/docs/developer_guides/creating_addtrack_workflow)
...
- [Renderer architecture](/docs/developer_guides/renderer_architecture) - how
  rendering is split between main thread and workers
- [Refname aliasing](/docs/developer_guides/refname_aliasing) - mapping between
  `chr1`/`1` style names and other conventions
- [PIF format](/docs/developer_guides/pif_format) - pairwise indexed PAF, the
  storage format behind synteny tracks

### See also

- [Extension points](/docs/developer_guides/extension_points) and the
  autogenerated [state model docs](/docs/models/assembly) for runtime APIs
- [Embedded components](/docs/embedded_components) for hosting JBrowse views
  inside your own React app
- [Admin server](/docs/quickstart_adminserver) for configuring JBrowse from a
  GUI rather than by hand-editing config.json
