...
| <span id="getter-loaded">**loaded**</span><br><code>boolean</code> | both halves of a ribbon's input have arrived: the alignments, and the per-assembly name tables that place each of their two ends. What the view's reorder waits on | ChordSyntenyDisplay |
