...
| [setUseWorkspaces](#action-setuseworkspaces)                 | Actions    | MultipleViewsSessionMixin                               | applies to this session and becomes the user's default for sessions that don't specify one. Persisted only here, on an explicit set — an autorun mirroring the resolved value would bake the admin default into every visitor's localStorage as if they had chosen it, leaving a later admin change unable to reach them.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| [resetUseWorkspaces](#action-resetuseworkspaces)             | Actions    | MultipleViewsSessionMixin                               | drop this session's value and the user's override so workspaces falls back to the admin default                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
