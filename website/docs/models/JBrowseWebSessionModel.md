...
| [editTrackConfiguration](#action-edittrackconfiguration)           | Actions    | [BaseWebSessionModel](../basewebsessionmodel)                           | opens the config editor for a track. Available for any track: edits to a non-session (admin-owned) track apply in-memory for the current session even when the user lacks rights to persist them.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
