...
**Properties:** [sessionPlugins](../basewebsessionmodel#property-sessionplugins)

**Volatiles:**
[sessionThemeName](../basewebsessionmodel#volatile-sessionthemename),
[pendingFileHandleIds](../basewebsessionmodel#volatile-pendingfilehandleids)

**Getters:** [root](../basewebsessionmodel#getter-root),
[connections](../basewebsessionmodel#getter-connections),
[shareURL](../basewebsessionmodel#getter-shareurl),
[textSearchManager](../basewebsessionmodel#getter-textsearchmanager)
...
[removeSessionPlugin](../basewebsessionmodel#action-removesessionplugin),
[setDefaultSession](../basewebsessionmodel#action-setdefaultsession),
[setSession](../basewebsessionmodel#action-setsession),
[editTrackConfiguration](../basewebsessionmodel#action-edittrackconfiguration),
[setPendingFileHandleIds](../basewebsessionmodel#action-setpendingfilehandleids)
...
**Getters:**
[savedSessionMetadata](../websessionmanagementmixin#getter-savedsessionmetadata)

**Actions:**
[deleteSavedSession](../websessionmanagementmixin#action-deletesavedsession),
[setSavedSessionFavorite](../websessionmanagementmixin#action-setsavedsessionfavorite),
[renameSavedSession](../websessionmanagementmixin#action-renamesavedsession),
[activateSession](../websessionmanagementmixin#action-activatesession)
