...
| <span id="getter-assemblies">**assemblies**</span><br><code>(ModelInstanceTypeProps&lt;…&gt; &amp; {…} &amp; IStateTreeNode&lt;…&gt;)[]</code> |  | [BaseSessionModel](../basesessionmodel#getter-assemblies) |
...
| <span id="action-revealhighlights">**revealHighlights**</span><br><code>() =&gt; void</code> | <span data-pagefind-ignore>turn highlight bands back on, so a newly made highlight or bookmark is visible even after an earlier "highlights off"</span> | [BaseSessionModel](../basesessionmodel#action-revealhighlights) |
