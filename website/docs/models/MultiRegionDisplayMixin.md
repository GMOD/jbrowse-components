...
| [clearAllRpcData](#action-clearallrpcdata)                         | Actions    | MultiRegionDisplayMixin                         | full reset: cancels fetch, clears error, regionTooLarge, loadedRegions, display-specific data, and the canvas-drawn flag                                                                                                                                                                                                                                                                                                                                                                       |
...
| [afterAttach](#action-afterattach)                                 | Actions    | MultiRegionDisplayMixin                         | installs the four fetch-lifecycle autoruns (DisplayedRegionsChange, FetchVisibleRegions, SettingsInvalidate, ClearBlockingStateOnViewportChange)                                                                                                                                                                                                                                                                                                                                               |
