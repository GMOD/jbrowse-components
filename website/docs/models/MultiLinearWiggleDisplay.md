...
| Member                                                 | Type                                                  |
| ------------------------------------------------------ | ----------------------------------------------------- |
| <span id="property-type">type</span>                   | `ISimpleType<"MultiLinearWiggleDisplay">`             |
...
| Member                                                     | Type           |
| ---------------------------------------------------------- | -------------- |
| <span id="volatile-sourcesvolatile">sourcesVolatile</span> | `SourceInfo[]` |
...
| Member                                                                             | Type                                                                                |
| ---------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- |
| <span id="getter-displaymessagecomponent">DisplayMessageComponent</span>           | `LazyExoticComponent<({ model, }: { model: MultiWiggleDisplayModel; }) => Element>` |
| <span id="getter-isdensitymode">isDensityMode</span>                               | `boolean`                                                                           |
| <span id="getter-isoverlay">isOverlay</span>                                       | `boolean`                                                                           |
| <span id="getter-sourceswithoutlayout">sourcesWithoutLayout</span>                 | `Source[]`                                                                          |
| <span id="getter-editablesources">editableSources</span>                           | `Source[]`                                                                          |
| <span id="getter-sources">sources</span>                                           | `Source[]`                                                                          |
| <span id="getter-numsources">numSources</span>                                     | `number`                                                                            |
| <span id="getter-autoscalesourcenames">autoscaleSourceNames</span>                 | `Set<string>`                                                                       |
| <span id="getter-rowheight">rowHeight</span>                                       | `number`                                                                            |
| <span id="getter-effectiverowheight">effectiveRowHeight</span>                     | `number`                                                                            |
| <span id="getter-rowheighttoosmallforscalebar">rowHeightTooSmallForScalebar</span> | `boolean`                                                                           |
...
| <span id="action-setshowrowseparators">setShowRowSeparators</span>         | `(arg: boolean) => void`                                                                                                                                     |
