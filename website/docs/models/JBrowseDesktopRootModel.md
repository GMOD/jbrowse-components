...
Auto-generated @jbrowse/mobx-state-tree API for the current JBrowse release — see [pluggable elements](/docs/developer_guide/) for concepts. [View source](https://github.com/GMOD/jbrowse-components/blob/main/products/jbrowse-desktop/src/rootModel/rootModel.ts).
...
| <span id="volatile-opennewsessioncallback">**openNewSessionCallback**</span><br><span class="cell-more"><button type="button" class="cell-more-trigger"><code>openNewSessionCallback: async (_path: string) =&gt; { console.erro…</code></button><dialog class="cell-dialog"><form method="dialog"><button class="cell-dialog-close" aria-label="Close">✕</button></form><pre><code>openNewSessionCallback: async (_path: string) =&gt; {&#10;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;console.error('openNewSessionCallback unimplemented')&#10;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;}</code></pre></dialog></span> |  | JBrowseDesktopRootModel |
| <span id="volatile-openlinkcallback">**openLinkCallback**</span><br><span class="cell-more"><button type="button" class="cell-more-trigger"><code>openLinkCallback: async (_link: string) =&gt; { console.error('ope…</code></button><dialog class="cell-dialog"><form method="dialog"><button class="cell-dialog-close" aria-label="Close">✕</button></form><pre><code>openLinkCallback: async (_link: string) =&gt; {&#10;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;console.error('openLinkCallback unimplemented')&#10;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;}</code></pre></dialog></span> |  | JBrowseDesktopRootModel |
| <span id="volatile-returntostartscreencallback">**returnToStartScreenCallback**</span><br><span class="cell-more"><button type="button" class="cell-more-trigger"><code>returnToStartScreenCallback: () =&gt; { console.error('returnToSta…</code></button><dialog class="cell-dialog"><form method="dialog"><button class="cell-dialog-close" aria-label="Close">✕</button></form><pre><code>returnToStartScreenCallback: () =&gt; {&#10;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;console.error('returnToStartScreenCallback unimplemented')&#10;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;}</code></pre></dialog></span> |  | JBrowseDesktopRootModel |
...
| <span id="action-savesession">**saveSession**</span><br><code>(val: SessionSnap) =&gt; Promise&lt;void&gt;</code> |  | JBrowseDesktopRootModel |
...
| <span id="action-initializeinternetaccount">**initializeInternetAccount**</span><br><span class="cell-more"><button type="button" class="cell-more-trigger"><code>(internetAccountConfig: AnyConfigurationModel, initialSnapshot?…</code></button><dialog class="cell-dialog"><form method="dialog"><button class="cell-dialog-close" aria-label="Close">✕</button></form><pre><code>(internetAccountConfig: AnyConfigurationModel, initialSnapshot?: object) =&gt; any</code></pre></dialog></span> |  | [InternetAccountsMixin](../internetaccountsmixin#action-initializeinternetaccount) |
