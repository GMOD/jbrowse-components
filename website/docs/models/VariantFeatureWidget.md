...
| Member | Description | Defined by |
| --- | --- | --- |
| <span id="getter-trackconfiguration">**trackConfiguration**</span><br><span class="cell-more"><button type="button" class="cell-more-trigger"><code>(ConfigNodeType&lt;…&gt; &amp; ModelInstanceTypeProps&lt;…&gt; &amp; {…} &amp; IStateTr…</code></button><dialog class="cell-dialog"><form method="dialog"><button class="cell-dialog-close" aria-label="Close">✕</button></form><pre><code>(ConfigNodeType&lt;…&gt; &amp; ModelInstanceTypeProps&lt;…&gt; &amp; {…} &amp; IStateTreeNode&lt;…&gt;) &#124; undefined</code></pre></dialog></span> | <span data-pagefind-ignore>the config the track tier of `formatDetails` reads. The open track's own while it is open; after it is closed, the session's copy of the same config, which is why the widget records `trackId`</span> | [BaseFeatureWidget](../basefeaturewidget#getter-trackconfiguration) |
