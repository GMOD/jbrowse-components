...
| [prefersOffset](#getter-prefersoffset)                               | Getters    | LinearWiggleDisplay                                   | Offset the track label above the plot so the left y-axis stays pinned to the content edge instead of dodging right of the label.                                                                                                                                                                                                                                                                        |
| [scoreRamp](#getter-scoreramp)                                       | Getters    | LinearWiggleDisplay                                   | The color ramp the density legend draws, or undefined when there is no single ramp to describe.                                                                                                                                                                                                                                                                                                         |
...
| Member                                                 | Type                                                  |
| ------------------------------------------------------ | ----------------------------------------------------- |
| <span id="property-type">type</span>                   | `ISimpleType<"LinearWiggleDisplay">`                  |
