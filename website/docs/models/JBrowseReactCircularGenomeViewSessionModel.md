...
| [updateTrackConfiguration](#action-updatetrackconfiguration)       | Actions    | [TracksManagerSessionMixin](../tracksmanagersessionmixin)               | Persist edited track config back to the in-memory jbrowse config.                                                                                                                                                                                                                                                  |
...
| Member                               | Type                                                                                                          |
| ------------------------------------ | ------------------------------------------------------------------------------------------------------------- |
| <span id="property-view">view</span> | `IModelType<_OverrideProps<…>, { ...; } & ... 8 more ... & { ...; }, _NotCustomized, ModelSnapshotType<...>>` |
...
| <span id="getter-views">views</span>                     | `(ModelInstanceTypeProps<_OverrideProps<{ id: IOptionalIType<…>; displayName: IMaybe<…>; minimized: IOptionalIType<…>; }, { ...; }>> & ... 10 more ... & IStateTreeNode<...>)[]` |
...
```ts
type addView = (typeName: string, initialState?: any) => ModelInstanceTypeProps<_OverrideProps<…>> & ... 10 more ... & IStateTreeNode<...>
```
