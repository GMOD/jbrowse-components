...
| Member | Description |
| --- | --- |
| <span id="action-addassemblyconf">**addAssemblyConf**</span><br><span class="cell-more"><button type="button" class="cell-more-trigger"><code>(conf: ConfigNodeType&lt;…&gt; &amp; ModelInstanceTypeProps&lt;…&gt; &amp; {…} &amp; IS…</code></button><dialog class="cell-dialog"><form method="dialog"><button class="cell-dialog-close" aria-label="Close">✕</button></form><pre><code>(conf: ConfigNodeType&lt;…&gt; &amp; ModelInstanceTypeProps&lt;…&gt; &amp; {…} &amp; IStateTreeNode&lt;…&gt;) =&gt; ConfigNodeType&lt;…&gt; &amp; ModelInstanceTypeProps&lt;…&gt; &amp; {…} &amp; IStateTreeNode&lt;…&gt;</code></pre></dialog></span> |  |
...
| <span id="action-deleteconnectionconf">**deleteConnectionConf**</span><br><span class="cell-more"><button type="button" class="cell-more-trigger"><code>(configuration: ConfigNodeType&lt;…&gt; &amp; ModelInstanceTypeProps&lt;…&gt; &amp;…</code></button><dialog class="cell-dialog"><form method="dialog"><button class="cell-dialog-close" aria-label="Close">✕</button></form><pre><code>(configuration: ConfigNodeType&lt;…&gt; &amp; ModelInstanceTypeProps&lt;…&gt; &amp; {…} &amp; IStateTreeNode&lt;…&gt;) =&gt; boolean</code></pre></dialog></span> |  |
| <span id="action-deletetrackconf">**deleteTrackConf**</span><br><span class="cell-more"><button type="button" class="cell-more-trigger"><code>(trackConf: (ConfigNodeType&lt;…&gt; &amp; ModelInstanceTypeProps&lt;…&gt; &amp; {……</code></button><dialog class="cell-dialog"><form method="dialog"><button class="cell-dialog-close" aria-label="Close">✕</button></form><pre><code>(trackConf: (ConfigNodeType&lt;…&gt; &amp; ModelInstanceTypeProps&lt;…&gt; &amp; {…} &amp; IStateTreeNode&lt;…&gt;) &#124; { ...; }) =&gt; void</code></pre></dialog></span> |  |
...
| <span id="action-setdefaultsessionconf">**setDefaultSessionConf**</span><br><span class="cell-more"><button type="button" class="cell-more-trigger"><code>(sessionConf: ConfigNodeType&lt;…&gt; &amp; ModelInstanceTypeProps&lt;…&gt; &amp; {…</code></button><dialog class="cell-dialog"><form method="dialog"><button class="cell-dialog-close" aria-label="Close">✕</button></form><pre><code>(sessionConf: ConfigNodeType&lt;…&gt; &amp; ModelInstanceTypeProps&lt;…&gt; &amp; {…} &amp; IStateTreeNode&lt;…&gt;) =&gt; void</code></pre></dialog></span> |  |
| <span id="action-addinternetaccountconf">**addInternetAccountConf**</span><br><span class="cell-more"><button type="button" class="cell-more-trigger"><code>(internetAccountConf: ConfigNodeType&lt;…&gt; &amp; ModelInstanceTypeProp…</code></button><dialog class="cell-dialog"><form method="dialog"><button class="cell-dialog-close" aria-label="Close">✕</button></form><pre><code>(internetAccountConf: ConfigNodeType&lt;…&gt; &amp; ModelInstanceTypeProps&lt;…&gt; &amp; {…} &amp; IStateTreeNode&lt;…&gt;) =&gt; any</code></pre></dialog></span> |  |
| <span id="action-deleteinternetaccountconf">**deleteInternetAccountConf**</span><br><span class="cell-more"><button type="button" class="cell-more-trigger"><code>(configuration: ConfigNodeType&lt;…&gt; &amp; ModelInstanceTypeProps&lt;…&gt; &amp;…</code></button><dialog class="cell-dialog"><form method="dialog"><button class="cell-dialog-close" aria-label="Close">✕</button></form><pre><code>(configuration: ConfigNodeType&lt;…&gt; &amp; ModelInstanceTypeProps&lt;…&gt; &amp; {…} &amp; IStateTreeNode&lt;…&gt;) =&gt; boolean</code></pre></dialog></span> |  |
