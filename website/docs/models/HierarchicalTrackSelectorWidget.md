...
| <span id="getter-configandsessiontrackconfigurations">**configAndSessionTrackConfigurations**</span><br><code>(ModelInstanceTypeProps&lt;…&gt; &amp; {…} &amp; IStateTreeNode&lt;…&gt;)[]</code> | the tracks this view can be offered — its assemblies' sequence tracks, then the session's list filtered to what it can draw |
...
| <span id="getter-favoritetracks">**favoriteTracks**</span><br><code>(ModelInstanceTypeProps&lt;…&gt; &amp; {…} &amp; IStateTreeNode&lt;…&gt;)[]</code> | filters out tracks that are not in the favorites group |
| <span id="getter-recentlyusedtracks">**recentlyUsedTracks**</span><br><code>(ModelInstanceTypeProps&lt;…&gt; &amp; {…} &amp; IStateTreeNode&lt;…&gt;)[]</code> | filters out tracks that are not in the recently used group |
