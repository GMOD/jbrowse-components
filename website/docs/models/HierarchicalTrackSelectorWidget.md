...
| <span id="getter-configandsessiontrackconfigurations">**configAndSessionTrackConfigurations**</span><br><code>(ModelInstanceTypeProps&lt;…&gt; &amp; {…} &amp; IStateTreeNode&lt;…&gt;)[]</code> | filter out tracks that don't match the current assembly/display types |
