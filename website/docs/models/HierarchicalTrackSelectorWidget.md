...
| <span id="volatile-selectionraw">**selectionRaw**</span><br><code>selectionRaw: [] as AnyConfigurationModel[]</code> | backing store for `selection`; read that instead, it drops entries whose track has since been deleted |
