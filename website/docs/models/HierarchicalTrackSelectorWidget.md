...
| <span id="volatile-sorttracknames">**sortTrackNames**</span><br><details><summary><code>sortTrackNames: localStorageGetJSON&lt;boolean &#124; undefined&gt;( sortT…</code></summary><pre><code>sortTrackNames: localStorageGetJSON&lt;boolean &#124; undefined&gt;(&#10;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;sortTrackNamesK,&#10;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;undefined,&#10;&#160;&#160;&#160;&#160;&#160;&#160;)</code></pre></details> |  |
| <span id="volatile-sortcategories">**sortCategories**</span><br><details><summary><code>sortCategories: localStorageGetJSON&lt;boolean &#124; undefined&gt;( sortC…</code></summary><pre><code>sortCategories: localStorageGetJSON&lt;boolean &#124; undefined&gt;(&#10;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;sortCategoriesK,&#10;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;undefined,&#10;&#160;&#160;&#160;&#160;&#160;&#160;)</code></pre></details> |  |
...
| <span id="getter-selectionset">**selectionSet**</span><br><details><summary><code>Set&lt;ModelInstanceTypeProps&lt;…&gt; &amp; { setSubschema(slotName: string…</code></summary><pre><code>Set&lt;ModelInstanceTypeProps&lt;…&gt; &amp; { setSubschema(slotName: string, data: Record&lt;string, unknown&gt;): any; setSlot(slotName: string, value: unknown): void; } &amp; IStateTreeNode&lt;...&gt;&gt;</code></pre></details> |  |
...
| <span id="getter-configandsessiontrackconfigurations">**configAndSessionTrackConfigurations**</span><br><details><summary><code>(ModelInstanceTypeProps&lt;…&gt; &amp; { setSubschema(slotName: string, d…</code></summary><pre><code>(ModelInstanceTypeProps&lt;…&gt; &amp; { setSubschema(slotName: string, data: Record&lt;string, unknown&gt;): any; setSlot(slotName: string, value: unknown): void; } &amp; IStateTreeNode&lt;...&gt;)[]</code></pre></details> | filter out tracks that don't match the current assembly/display types |
| <span id="getter-alltrackconfigurations">**allTrackConfigurations**</span><br><details><summary><code>(ModelInstanceTypeProps&lt;…&gt; &amp; { setSubschema(slotName: string, d…</code></summary><pre><code>(ModelInstanceTypeProps&lt;…&gt; &amp; { setSubschema(slotName: string, data: Record&lt;string, unknown&gt;): any; setSlot(slotName: string, value: unknown): void; } &amp; IStateTreeNode&lt;...&gt;)[]</code></pre></details> |  |
| <span id="getter-alltrackconfigurationmap">**allTrackConfigurationMap**</span><br><details><summary><code>Map&lt;any, ModelInstanceTypeProps&lt;…&gt; &amp; { setSubschema(slotName: s…</code></summary><pre><code>Map&lt;any, ModelInstanceTypeProps&lt;…&gt; &amp; { setSubschema(slotName: string, data: Record&lt;string, unknown&gt;): any; setSlot(slotName: string, value: unknown): void; } &amp; IStateTreeNode&lt;...&gt;&gt;</code></pre></details> | unfiltered map of every track (incl. connection tracks for other assemblies/view types); used by the faceted selector |
| <span id="getter-displayabletrackconfigurationmap">**displayableTrackConfigurationMap**</span><br><details><summary><code>Map&lt;any, ModelInstanceTypeProps&lt;…&gt; &amp; { setSubschema(slotName: s…</code></summary><pre><code>Map&lt;any, ModelInstanceTypeProps&lt;…&gt; &amp; { setSubschema(slotName: string, data: Record&lt;string, unknown&gt;): any; setSlot(slotName: string, value: unknown): void; } &amp; IStateTreeNode&lt;...&gt;&gt;</code></pre></details> | map restricted to tracks the current view can display; connection tracks go through the same filterTracks() pass as the tree so favorites and recently-used don't surface tracks the view can't show |
| <span id="getter-favoritetracks">**favoriteTracks**</span><br><details><summary><code>(ModelInstanceTypeProps&lt;…&gt; &amp; { setSubschema(slotName: string, d…</code></summary><pre><code>(ModelInstanceTypeProps&lt;…&gt; &amp; { setSubschema(slotName: string, data: Record&lt;string, unknown&gt;): any; setSlot(slotName: string, value: unknown): void; } &amp; IStateTreeNode&lt;...&gt;)[]</code></pre></details> | filters out tracks that are not in the favorites group |
| <span id="getter-recentlyusedtracks">**recentlyUsedTracks**</span><br><details><summary><code>(ModelInstanceTypeProps&lt;…&gt; &amp; { setSubschema(slotName: string, d…</code></summary><pre><code>(ModelInstanceTypeProps&lt;…&gt; &amp; { setSubschema(slotName: string, data: Record&lt;string, unknown&gt;): any; setSlot(slotName: string, value: unknown): void; } &amp; IStateTreeNode&lt;...&gt;)[]</code></pre></details> | filters out tracks that are not in the recently used group |
| <span id="getter-alltracks">**allTracks**</span><br><details><summary><code>{ group: string; id: string; tracks: (ModelInstanceTypeProps&lt;…&gt;…</code></summary><pre><code>{ group: string; id: string; tracks: (ModelInstanceTypeProps&lt;…&gt; &amp; {…} &amp; IStateTreeNode&lt;…&gt;)[]; noCategories: boolean; defaultCollapsed: boolean; loading: boolean; }[]</code></pre></details> |  |
...
| Member | Description |
| --- | --- |
| <span id="method-isselected">**isSelected**</span><br><details><summary><code>(track: ModelInstanceTypeProps&lt;…&gt; &amp; { setSubschema(slotName: st…</code></summary><pre><code>(track: ModelInstanceTypeProps&lt;…&gt; &amp; { setSubschema(slotName: string, data: Record&lt;…&gt;): any; setSlot(slotName: string, value: unknown): void; } &amp; IStateTreeNode&lt;...&gt;) =&gt; boolean</code></pre></details> |  |
...
| <span id="method-getrefseqtrackconf">**getRefSeqTrackConf**</span><br><details><summary><code>(assemblyName: string) =&gt; (ModelInstanceTypeProps&lt;…&gt; &amp; {…} &amp; IS…</code></summary><pre><code>(assemblyName: string) =&gt; (ModelInstanceTypeProps&lt;…&gt; &amp; {…} &amp; IStateTreeNode&lt;…&gt;) &#124; undefined</code></pre></details> |  |
| <span id="method-itemoffsets">**itemOffsets**</span><br><details><summary><code>(height: number, scrollTop: number) =&gt; { startIndex: number; en…</code></summary><pre><code>(height: number, scrollTop: number) =&gt; { startIndex: number; endIndex: number; }</code></pre></details> |  |
...
| <span id="action-setselection">**setSelection**</span><br><details><summary><code>(elt: (ModelInstanceTypeProps&lt;…&gt; &amp; { setSubschema(slotName: str…</code></summary><pre><code>(elt: (ModelInstanceTypeProps&lt;…&gt; &amp; { setSubschema(slotName: string, data: Record&lt;…&gt;): any; setSlot(slotName: string, value: unknown): void; } &amp; IStateTreeNode&lt;...&gt;)[]) =&gt; void</code></pre></details> |  |
| <span id="action-addtoselection">**addToSelection**</span><br><details><summary><code>(elt: (ModelInstanceTypeProps&lt;…&gt; &amp; { setSubschema(slotName: str…</code></summary><pre><code>(elt: (ModelInstanceTypeProps&lt;…&gt; &amp; { setSubschema(slotName: string, data: Record&lt;…&gt;): any; setSlot(slotName: string, value: unknown): void; } &amp; IStateTreeNode&lt;...&gt;)[]) =&gt; void</code></pre></details> |  |
| <span id="action-removefromselection">**removeFromSelection**</span><br><details><summary><code>(elt: (ModelInstanceTypeProps&lt;…&gt; &amp; { setSubschema(slotName: str…</code></summary><pre><code>(elt: (ModelInstanceTypeProps&lt;…&gt; &amp; { setSubschema(slotName: string, data: Record&lt;…&gt;): any; setSlot(slotName: string, value: unknown): void; } &amp; IStateTreeNode&lt;...&gt;)[]) =&gt; void</code></pre></details> |  |
