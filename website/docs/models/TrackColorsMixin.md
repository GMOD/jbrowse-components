...
| <span id="getter-haslegendkey">**hasLegendKey**</span><br><code>boolean</code> | Whether the mode has a key worth a box: a track palette, a ramp, or a reader-named column. The two structural presets key nothing on screen — their colors are the menu preview's. |
