...
| <span id="action-revealhighlights">**revealHighlights**</span><br><code>() =&gt; void</code> | turn highlight bands back on, so a newly made highlight or bookmark is visible even after an earlier "highlights off" | BaseSessionModel |
