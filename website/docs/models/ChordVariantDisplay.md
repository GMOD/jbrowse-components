...
| <span id="getter-displayerror">**displayError**</span><br><code>unknown</code> | what the error ring shows; the fetch's error, since this display waits on nothing else | ChordVariantDisplay |
