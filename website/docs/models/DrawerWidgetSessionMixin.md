...
| <span id="action-addwidget">**addWidget**</span><br><details><summary><code>(typeName: string, id: string, initialState?: any, conf?: unkno…</code></summary><pre><code>(typeName: string, id: string, initialState?: any, conf?: unknown) =&gt; any</code></pre></details> |  |
...
| <span id="action-editconfiguration">**editConfiguration**</span><br><details><summary><code>(configuration: (ModelInstanceTypeProps&lt;…&gt; &amp; {…} &amp; IStateTreeNo…</code></summary><pre><code>(configuration: (ModelInstanceTypeProps&lt;…&gt; &amp; {…} &amp; IStateTreeNode&lt;…&gt;) &#124; { ...; }, opts?: { ...; } &#124; undefined) =&gt; void</code></pre></details> | opens a configuration editor to configure the given thing, and sets the current task to be configuring it |
