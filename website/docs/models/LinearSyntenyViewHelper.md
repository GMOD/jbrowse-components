...
| <span id="getter-linearsyntenydisplays">**linearSyntenyDisplays**</span><br><span class="cell-more"><button type="button" class="cell-more-trigger"><code>(ModelInstanceTypeProps&lt;_OverrideProps&lt;Omit&lt;…&gt;, { type: ISimple…</code></button><dialog class="cell-dialog"><form method="dialog"><button class="cell-dialog-close" aria-label="Close">✕</button></form><pre><code>(ModelInstanceTypeProps&lt;_OverrideProps&lt;Omit&lt;…&gt;, { type: ISimpleType&lt;…&gt;; configuration: IConfigurationReference&lt;...&gt;; }&gt;&gt; &amp; ... 12 more ... &amp; IStateTreeNode&lt;...&gt;)[]</code></pre></dialog></span> | All synteny displays under this level's tracks. | LinearSyntenyViewHelper |
...
| Member | Description |
| --- | --- |
| <span id="method-displayfor">**displayFor**</span><br><span class="cell-more"><button type="button" class="cell-more-trigger"><code>(key: number) =&gt; (ModelInstanceTypeProps&lt;_OverrideProps&lt;Omit&lt;…&gt;…</code></button><dialog class="cell-dialog"><form method="dialog"><button class="cell-dialog-close" aria-label="Close">✕</button></form><pre><code>(key: number) =&gt; (ModelInstanceTypeProps&lt;_OverrideProps&lt;Omit&lt;…&gt;, { ...; }&gt;&gt; &amp; ... 12 more ... &amp; IStateTreeNode&lt;...&gt;) &#124; undefined</code></pre></dialog></span> | The display a pick hit belongs to. A scan over the level's handful of displays, not a keyed map: the map this replaces was a computed no reaction observed, so every access rebuilt it in full anyway. |
...
| <span id="action-sethoveredfeature">**setHoveredFeature**</span><br><span class="cell-more"><button type="button" class="cell-more-trigger"><code>(hit: SyntenyPickResult &#124; undefined) =&gt; (ModelInstanceTypeProps…</code></button><dialog class="cell-dialog"><form method="dialog"><button class="cell-dialog-close" aria-label="Close">✕</button></form><pre><code>(hit: SyntenyPickResult &#124; undefined) =&gt; (ModelInstanceTypeProps&lt;_OverrideProps&lt;Omit&lt;…&gt;, { ...; }&gt;&gt; &amp; ... 12 more ... &amp; IStateTreeNode&lt;...&gt;) &#124; undefined</code></pre></dialog></span> |  | LinearSyntenyViewHelper |
| <span id="action-setclickedfeature">**setClickedFeature**</span><br><span class="cell-more"><button type="button" class="cell-more-trigger"><code>(hit: SyntenyPickResult &#124; undefined) =&gt; (ModelInstanceTypeProps…</code></button><dialog class="cell-dialog"><form method="dialog"><button class="cell-dialog-close" aria-label="Close">✕</button></form><pre><code>(hit: SyntenyPickResult &#124; undefined) =&gt; (ModelInstanceTypeProps&lt;_OverrideProps&lt;Omit&lt;…&gt;, { ...; }&gt;&gt; &amp; ... 12 more ... &amp; IStateTreeNode&lt;...&gt;) &#124; undefined</code></pre></dialog></span> | Clicked-state twin of `setHoveredFeature`. | LinearSyntenyViewHelper |
