...
| <span id="method-gettrackactionmenuitems">**getTrackActionMenuItems**</span><br><details><summary><code>({…}: { config: ModelInstanceTypeProps&lt;…&gt; &amp; {…} &amp; IStateTreeNod…</code></summary><pre><code>({…}: { config: ModelInstanceTypeProps&lt;…&gt; &amp; {…} &amp; IStateTreeNode&lt;…&gt;; view?: TrackActionView &#124; undefined; }) =&gt; MenuItem[]</code></pre></details> | track menu with About + "Track actions" submenu for the in-view label |
