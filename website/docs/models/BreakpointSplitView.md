...
| [interactiveOverlay](#property-interactiveoverlay)               | Properties |                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| [showHeader](#property-showheader)                               | Properties |                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| [views](#property-views)                                         | Properties |                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| [init](#property-init)                                           | Properties | declarative child panels (loc/assembly/tracks) resolved into `views` once the view has a width; used for initializing from a session snapshot. Transient — stripped by postProcessSnapshot.                                                                                                                                                                                                                                                                          |
| [width](#volatile-width)                                         | Volatiles  |                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| [matchedTrackFeatures](#volatile-matchedtrackfeatures)           | Volatiles  |                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| [hasSomethingToShow](#getter-hassomethingtoshow)                 | Getters    |                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| [initialized](#getter-initialized)                               | Getters    |                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| [showImportForm](#getter-showimportform)                         | Getters    |                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| [assembly](#getter-assembly)                                     | Getters    |                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| [matchedTracks](#getter-matchedtracks)                           | Getters    | Find all track ids that match across multiple views, or return just the single view's track if only a single row is used                                                                                                                                                                                                                                                                                                                                             |
| [overlayMatches](#getter-overlaymatches)                         | Getters    | Zero-arg cached getter: classifies each matched track, pairs its features, looks up layout rectangles, and returns a Map keyed by trackId. Mobx caches this across renders and only invalidates when the underlying feature or layout reads change — so horizontal/vertical scrolling and track resizing do NOT trigger re-pairing or re-lookup.                                                                                                                     |
| [exportSvg](#method-exportsvg)                                   | Methods    | creates an svg export and save using FileSaver                                                                                                                                                                                                                                                                                                                                                                                                                       |
| [getMatchedTracks](#method-getmatchedtracks)                     | Methods    | Get tracks with a given trackId across multiple views. Callers that index the result by view level (getTrackOverlayData, getMatchedFeaturesInLayout) rely on it staying aligned with `views` — which holds only because overlays are driven by `overlayMatches`, whose trackIds come from `matchedTracks` (the intersect across all views), so the track is present in every view and `filter` drops nothing. Don't level-index the result for an arbitrary trackId. |
| [getTrackOverlayData](#method-gettrackoverlaydata)               | Methods    | Per-render precompute for an overlay track. Gathers scroll top, display height, coverage offset, and view offsetPx per level, then returns getX/getY closures for converting feature layout records to SVG coordinates. `yOffsetsOverride` — SVG export: fixed track tops, scrollTops zeroed. `domYOffsets` — live rendering: DOM-measured track tops (relative to the overlay SVG), scrollTops still read from model.                                               |
| [getMatchedFeaturesInLayout](#method-getmatchedfeaturesinlayout) | Methods    |                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| [menuItems](#method-menuitems)                                   | Methods    |                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| [rubberBandMenuItems](#method-rubberbandmenuitems)               | Methods    |                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| [setWidth](#action-setwidth)                                     | Actions    |                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| [setInteractiveOverlay](#action-setinteractiveoverlay)           | Actions    |                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| [setShowIntraviewLinks](#action-setshowintraviewlinks)           | Actions    |                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| [setLinkViews](#action-setlinkviews)                             | Actions    |                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| [setShowHeader](#action-setshowheader)                           | Actions    |                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| [setMatchedTrackFeatures](#action-setmatchedtrackfeatures)       | Actions    |                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| [reverseViewOrder](#action-reversevieworder)                     | Actions    |                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
