...
| [regionTooLargeState](#volatile-regiontoolargestate)               | Volatiles  | RegionTooLargeMixin |                                                                                                                                                                                                                        |
| [regionTooLargeReasonState](#volatile-regiontoolargereasonstate)   | Volatiles  | RegionTooLargeMixin |                                                                                                                                                                                                                        |
...
| [setRegionTooLarge](#action-setregiontoolarge)                     | Actions    | RegionTooLargeMixin |                                                                                                                                                                                                                        |
| [setFeatureDensityStats](#action-setfeaturedensitystats)           | Actions    | RegionTooLargeMixin |                                                                                                                                                                                                                        |
| [setFeatureDensityStatsLimit](#action-setfeaturedensitystatslimit) | Actions    | RegionTooLargeMixin | force-load: raise the byte limit past the current request and clear the too-large banner                                                                                                                               |
