...
| [ldAdapterConfig](#getter-ldadapterconfig)                         | Getters    | LinearManhattanDisplay                                | the configured PLINK .ld adapter, or undefined when none is set (the slot defaults to null, normalized here to undefined for "absent")                                                                                                                                                                                                                                                                                                                                                         |
