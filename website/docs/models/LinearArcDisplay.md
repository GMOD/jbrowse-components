...
| [arcStyles](#getter-arcstyles)                                       | Getters    | LinearArcDisplay                              | per-feature arc styling, evaluated once when features/config change.                                                                                                                                                                              |
...
| [byteGateEnabled](#getter-bytegateenabled)                           | Getters    | [ArcFetchModel](../arcfetchmodel)             |                                                                                                                                                                                                                                                   |
...
| Member                                                 | Type                                                  |
| ------------------------------------------------------ | ----------------------------------------------------- |
| <span id="property-type">type</span>                   | `ISimpleType<"LinearArcDisplay">`                     |
...
| Member                                           | Type                      |
| ------------------------------------------------ | ------------------------- |
| <span id="getter-displaymode">displayMode</span> | `"arcs" \| "semicircles"` |
