...
| Member | Description | Defined by |
| --- | --- | --- |
| <span id="action-gettokenfromuser">**getTokenFromUser**</span><br><details><summary><code>(resolve: (token: string) =&gt; void, reject: (error: Error) =&gt; vo…</code></summary><pre><code>(resolve: (token: string) =&gt; void, reject: (error: Error) =&gt; void) =&gt; void</code></pre></details> | <span data-pagefind-ignore>Prompt the user for a token via the account's dialog form, resolving with the entered token or rejecting if the user cancels.</span> | [TokenEntryInternetAccount](../tokenentryinternetaccount#action-gettokenfromuser) |
