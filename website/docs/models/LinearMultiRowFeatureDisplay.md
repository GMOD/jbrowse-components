...
| [contextMenuItems](#method-contextmenuitems)                 | Methods    | Items for the right-click context menu, built from the clicked position (contextMenuInfo). "Sort rows by color here" is the interactive twin of the declarative `sortRowsBy`.                                                                                                                                                                                                       |
