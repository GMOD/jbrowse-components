...
| [colorConfig](#getter-colorconfig)                                 | Getters    | LinearMultiRowFeatureDisplay                          | Raw `color` slot (a CSS color or `jexl:` string), forwarded to the worker which resolves it per feature.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
