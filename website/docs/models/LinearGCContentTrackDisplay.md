...
| [adapterConfig](#getter-adapterconfig)                             | Getters    | LinearGCContentTrackDisplay                           | the parent GCContentTrack's adapter is already a GCContentAdapter, so use it directly and apply the current display parameter overrides                                                                                                                                                                                                                                                                                                                                                        |
