...
// `assembly`, `displayedRegionNames` and `autoDiagonalize` collide with
// nothing — the model declares none of them, and `displayedRegions` is the
// resolved form of the second.
