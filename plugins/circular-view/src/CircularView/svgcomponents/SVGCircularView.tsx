...
export async function renderToSvg(
  ...
  const { figureSize, offsetRadians, centerXY } = model
  ...
  return wrapSvgExport({
    ...
    width: figureSize,
    height: figureSize,
    // paddingPx already reserves the gutter the labels sit in
    margin: 0,
    fontFamily,
    Wrapper,
    children: (
      <g
        transform={`translate(${centerXY}) rotate(${radToDeg(offsetRadians)})`}
      >
        <Rulers model={model} />
