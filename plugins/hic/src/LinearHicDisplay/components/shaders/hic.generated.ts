...
export function writeUniforms(buf: ArrayBuffer, uniforms: Uniforms) {
  ...
  f32[5] = uniforms.colorMaxScore
  f32[6] = uniforms.viewScale
  f32[7] = uniforms.viewOffsetX
  u32[8] = uniforms.useLogScale
}
