...
// 15-node, 2-haplotype pangenome from the sequenceTubeMap examples — paths are
// what make a tube map interesting, so the example carries P-lines.
