 ...
 * the row label, which the sidebar tints from that same field (see
 * `labelSources`). While the tint was being dropped on the way to the sidebar
 * the exclusion was self-consistent; now that it isn't, hiding the column would
 * leave the adapter config able to set something the UI could not.
 *
