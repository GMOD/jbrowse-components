...
function level({ width = 800, height = 100 } = {}) {
  return {
    level: 0,
    height,
...
// the overlay laid out at twice the band on a retina display, so every stub and
...
// saw and the stub their click resolved were in different places — the one thing
