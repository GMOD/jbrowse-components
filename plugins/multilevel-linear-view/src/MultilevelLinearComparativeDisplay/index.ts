...
export default (pluginManager: PluginManager) => {
  pluginManager.addDisplayType(() => {
    ...
    return new DisplayType({
      name: 'MultilevelLinearComparativeDisplay',
      configSchema,
      stateModel: stateModelFactory(configSchema),
      trackType: 'MultilevelTrack',
      viewType: 'MultilevelLinearComparativeView',
      ReactComponent,
    })
  })
}
...
export function configSchemaFactory(pluginManager: any) {
  return ConfigurationSchema(
    'MultilevelLinearComparativeDisplay',
...
export function stateModelFactory(configSchema: any) {
  return types
    .compose(
      ...
      BaseDisplay,
      types.model({
        type: types.literal('MultilevelLinearComparativeDisplay'),
...
function renderBlockData(self: MultilevelLinearComparativeDisplay) {
  ...
  const parent = getContainingView(self) as MultilevelLinearComparativeViewModel
...
export type MultilevelLinearComparativeDisplayModel = ReturnType<
  typeof stateModelFactory
>
export type MultilevelLinearComparativeDisplay =
  Instance<MultilevelLinearComparativeDisplayModel>
