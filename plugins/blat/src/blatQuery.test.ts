...
const response = {
  ...
  blat: [
    [
      133, 13, 0, 0, 0, 0, 0, 0, '+', 'YourSeq', 147, 1, 147, 'chr6', 170805979,
      34345901, 34346047, 1, '146', '1', '34345901',
    ],
    [
      140, 5, 0, 0, 1, 1, 2, 137, '-', 'YourSeq', 147, 1, 147, 'chr17',
      83257441, 17301795, 17302077, 3, '31,101,13', '0,32,133',
