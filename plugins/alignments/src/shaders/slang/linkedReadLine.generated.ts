...
export function writeInstance(buf: ArrayBuffer, instanceIndex: number, inst: Instance) {
  ...
  dv.setUint32(base + 0, inst.bp1, true)
  dv.setUint32(base + 4, inst.bp2, true)
  dv.setFloat32(base + 8, inst.y1, true)
  dv.setFloat32(base + 12, inst.y2, true)
  dv.setFloat32(base + 16, inst.colorType, true)
}
