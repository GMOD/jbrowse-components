...
// Zeroes out frequencies below a depth-dependent threshold. Features whose
// frequency is below the threshold for the local coverage depth are suppressed
// (set to 0); features at or above the threshold are kept unchanged.
