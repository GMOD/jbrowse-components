import { INTERBASE_HARDCLIP, INTERBASE_INSERTION } from '../shared/types.ts'
import { makePileupData } from './sortLayout.fixture.ts'
import {
...
import type { Read } from './sortLayout.fixture.ts'
