...
maybe('insertion sort matches JBrowse read-for-read', () => {
  const reads: Read[] = [
    {
      ...span(1)[0]!,
      softclip: { pos: SORT_POS, length: 5, type: INTERBASE_INSERTION },
    },
    {
      ...span(1)[0]!,
      softclip: { pos: SORT_POS, length: 30, type: INTERBASE_INSERTION },
    },
    { ...span(1)[0]! }, // no insertion — sorts last
    {
      ...span(1)[0]!,
      softclip: { pos: SORT_POS, length: 12, type: INTERBASE_INSERTION },
    },
  ]
  const r = rLayout(
    reads,
