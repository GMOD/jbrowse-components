...
export type { ArcBandFeed } from './features/arcs/bandFeed.ts'
...
export type { LaneJunction } from './features/sashimi/supportingReads.ts'
export type { ReadSlot } from './shared/readSlot.ts'
