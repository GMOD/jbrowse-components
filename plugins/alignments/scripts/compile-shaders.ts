...
function main() {
  ...
  output += '// Run: npx tsx plugins/alignments/scripts/compile-shaders.ts\n\n'
  ...
  writeFileSync(join(outDir, 'index.ts'), output)

  rmSync(tmpDir, { recursive: true })

  console.log(`Generated ${results.length} shader pairs to ${outDir}/index.ts`)
}
