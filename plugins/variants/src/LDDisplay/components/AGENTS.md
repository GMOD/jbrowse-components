...
MultiWebGLVariantMatrixDisplay) do use naga-compiled GLSL from WGSL sources,
but the LD display uses texture-based color ramps and a different data passing
