    ...
    types
      ...
      .actions(self => ({
        ...
        async renderSvg(opts: ExportSvgDisplayOptions) {
          ...
          return renderBaseLinearDisplaySvg(
            self as BaseLinearDisplayModel,
            opts,
          )
        },
        afterAttach() {
      ...
      // height/heightPreConfig → heightOverride is handled by TrackHeightMixin's
      // own migration (composed above), so no height preProcessSnapshot here.
