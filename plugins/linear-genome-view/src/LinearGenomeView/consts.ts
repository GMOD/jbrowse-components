...
// Height of the band a detail level's trapezoid is drawn in: the default the
// level's own property starts at, and the floor a drag on the band stops at,
// since the band is its own drag handle.
export const DETAIL_CONNECTOR_HEIGHT = 16
export const MIN_DETAIL_CONNECTOR_HEIGHT = 4
