...
function getNodeData(
  ...
  extra: {
    ...
    toggleCollapse: (pathName: string) => void
    tree: unknown
    model: unknown
...
const HierarchicalTree = observer(function HierarchicalTree({
  ...
  const treeRef = useRef<VariableSizeTree<NodeData['data']>>(null)
  ...
  function* treeWalker() {
    ...
    while (true) {
      const parentMeta: NodeData = yield
    ...
    // needed for proper ts, but is unreachable
    return undefined
  }
