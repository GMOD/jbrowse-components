        ...
        subfeatures: [
          {
            ...
            subfeatures: [
              ...
              { uniqueId: 'exon1', refName: 'ctgA', type: 'exon', start: 10, end: 50, strand: 1 },
              { uniqueId: 'exon2', refName: 'ctgA', type: 'exon', start: 80, end: 120, strand: 1 },
              { uniqueId: 'exon3', refName: 'ctgA', type: 'exon', start: 150, end: 200, strand: 1 },
              // CDS that doesn't cover full exon extent - should create implied UTRs
              { uniqueId: 'cds1', refName: 'ctgA', type: 'CDS', start: 30, end: 50, strand: 1, phase: 0 },
              { uniqueId: 'cds2', refName: 'ctgA', type: 'CDS', start: 80, end: 120, strand: 1, phase: 0 },
              { uniqueId: 'cds3', refName: 'ctgA', type: 'CDS', start: 150, end: 180, strand: 1, phase: 0 },
            ],
          },
        ],
      }),
