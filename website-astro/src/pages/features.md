...
and reusable. Individual views (linear, circular, tabular, etc.) can be
packaged as embeddable components for other web applications, as demonstrated by
[@jbrowse/react-linear-genome-view](https://www.npmjs.com/package/@jbrowse/react-linear-genome-view).

See the full list of [embedded components](https://jbrowse.org/jb2/docs/embedded_components/).

[^1]: Requires the trackhub server to allow
