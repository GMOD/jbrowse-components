...
```js
// @jbrowse/mobx-state-tree is JBrowse's bundled MST fork — install it alongside @jbrowse/react-app2
...
The example below logs the most recent patches — pan, zoom, or toggle a track to
see them stream in:
