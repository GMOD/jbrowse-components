...
a build without a CSS loader can link
`node_modules/@jbrowse/react-app2/dist/styles.css` directly instead.
...
between the two, but unlike JBrowse Web the embedded component never
...
view snapshot/`init` fields under
