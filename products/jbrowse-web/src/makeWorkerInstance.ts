// Byte-identical to the sibling products' copy, and deliberately not shared:
// the bundler resolves `./rpcWorker` relative to THIS file, and each product's
// rpcWorker registers that product's own corePlugins. A shared module would
// hand every product product-core's worker, with the wrong plugin set.
