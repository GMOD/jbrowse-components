...
test('test regular orientation inverted alignment', async () => {
  console.warn = jest.fn()
  const str = `?config=test_data%2Fgrape_peach_synteny%2Fconfig.json&session=spec-${JSON.stringify(
    {
      views: [
...
test('test regular orientation inverted alignment bottom', async () => {
  console.warn = jest.fn()
  const str = `?config=test_data%2Fgrape_peach_synteny%2Fconfig.json&session=spec-${JSON.stringify(
    {
      views: [
...
test('test regular orientation both horizontally flipped', async () => {
  console.warn = jest.fn()
  const str = `?config=test_data%2Fgrape_peach_synteny%2Fconfig.json&session=spec-${JSON.stringify(
    {
      views: [
