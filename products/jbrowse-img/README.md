...
![One junction of the COLO829 melanoma line's der(3): chr3 above, chr12 below, with a curve per tumour read that crosses between them](https://jbrowse.org/jb2-figures/jbrowse-img/sv_review_tumor.33db9c18bec0.png)
...
![The same two windows in the matched normal COLO829BL: reads read straight through both loci and nothing connects the panels](https://jbrowse.org/jb2-figures/jbrowse-img/sv_review_normal.7290e1f63e73.png)
