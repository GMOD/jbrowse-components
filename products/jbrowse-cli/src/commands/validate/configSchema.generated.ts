...
export const configJsonSchema: Record<string, unknown> = JSON.parse(`
{
  ...
  "description": "The JBrowse 5.0.0-beta.7 config.json: assemblies, tracks, connections, site-wide configuration and a default session. Generated from the registered types by \`pnpm autogen\`.",
  "type": "object",
  "properties": {
    "$schema": {
      "type": "string",
