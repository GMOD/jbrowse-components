...
[JBrowse 2 React Circular Genome View
Component](https://www.npmjs.com/package/@jbrowse/react-circular-genome-view).
The component makes it possible to embed an interactive genome browser in any
React application. The Storybook docs make it possible to provide an
interactive demonstration of how the component looks and works.
...
- [Story source
code](https://github.com/GMOD/jbrowse-components/tree/main/products/jbrowse-react-circular-genome-view/stories)
