...
<Canvas>
  <Story id="circular-genome-view--volvox" />
</Canvas>
...
<Canvas>
  <Story id="circular-genome-view--show-track" />
</Canvas>

## Additional resources

This overview is intended as a launching point for initial use of the CGV component.
Make sure to check out the rest of the stories to get a better feel for what is possible
with the component.
