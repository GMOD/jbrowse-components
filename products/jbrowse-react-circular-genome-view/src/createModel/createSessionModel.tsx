 ...
 *
 * Consolidated session model for jbrowse-react-circular-genome-view.
 */
export default function sessionModelFactory(pluginManager: PluginManager) {
  ...
  return types
    ...
    .views(self => ({
      get root(): CGVRootModel {
        return getParent<CGVRootModel>(self)
      },
    }))
    .views(self => ({
      get jbrowse() {
...
export type CGVSessionModelType = ReturnType<typeof sessionModelFactory>
export type CGVSessionModel = Instance<CGVSessionModelType>

// eslint-disable-next-line @typescript-eslint/no-unused-vars
function z(x: Instance<CGVSessionModelType>): AbstractSessionModel {
