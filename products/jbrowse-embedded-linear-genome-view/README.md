...
Events flow **out** through callbacks; mutations flow **in** through methods;
the controller owns the whole lifecycle (async assembly resolution, rebuilds,
teardown).
...
- **a hub name** — `'hg38'`, `'mm10'`, or a GenArk accession
  `'GCF_000001405.40'`. Fetched from jbrowse.org; its refName aliases,
  cytobands, and text-search adapters come along for free.
