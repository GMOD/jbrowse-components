...
export const Example = () => {
  ...
  return (
    <div>
      ...
      <a href="https://github.com/GMOD/jbrowse-components/blob/main/products/jbrowse-react-linear-genome-view/stories/WithTextSearching.stories.tsx">
        Source code
      </a>
    </div>
  )
...
export default { title: 'Source: With text searching' }
