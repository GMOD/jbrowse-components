...
export const WithOutsideStyling = () => {
  ...
  return (
    <>
      <style
        dangerouslySetInnerHTML={{ __html: `html { font-size: 10px; }` }}
      ></style>
      <div style={{ textAlign: 'center', fontFamily: 'monospace' }}>
        ...
        <p>
          ...
          outside of it on the page. In this case, a font and a text align,
          which without measures could affect the
          jbrowse-react-linear-genome-view component, is fine here.
        </p>
