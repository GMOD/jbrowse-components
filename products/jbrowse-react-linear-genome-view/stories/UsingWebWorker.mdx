...
to use web workers from v2.1.6 forward. By importing `makeWorkerInstance` and
adding the `WebWorkerRpcDriver` configuration to `createViewState`, the app will
use the WebWorker RPC
