...
<Story id="source-with-locally-defined-plugins--example" />

## Plugins loaded from external URL

This example loads a plugin from an external URL

<Story id="source-loading-plugins-from-external-urls--example" />

## Plugins loaded from NPM

This example is similar to defining an inline plugin. This is not a live example
as we are not actually installing jbrowse-plugin-gwas into our monorepo, but you
can do this in your own code
