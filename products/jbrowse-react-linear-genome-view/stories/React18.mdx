...
then you will also want to pass a hydrateFn to createViewState that corresponds
to react-dom/client::hydrateRoot. JBrowse will fallback to normal
react-dom::hydrate if it is not specified, but you will likely get more
consistent react 18 behavior by specifying this.
