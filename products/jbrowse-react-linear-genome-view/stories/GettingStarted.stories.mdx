...
<Story id="source-code-for-examples--one-linear-genome-view" />
...
<Story id="source-code-for-examples--using-loc-object" name="Using location" />
...
<Story
  id="source-code-for-examples--disable-add-track"
  name="Disable add tracks"
/>
...
<Story id="source-code-for-examples--with-show-track" name="Show track" />
