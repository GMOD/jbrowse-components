...
React application.
The Storybook docs make it possible to provide an interactive demonstration of
how the component looks and works.
...
You can also set an initial location for when the browser first loads on the package
when you initialize the state of the component with your configuration values:
...
- [Full working example](https://github.com/GMOD/jbrowse-components/blob/HEAD/products/jbrowse-react-linear-genome-view/docs/example.md)
- The guide for creating default sessions

<!-- 
I tried linking to the story for default sessions but couldn't get it
to work
-->
