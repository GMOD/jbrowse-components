...
This demo shows how to browse the SARS-CoV-2 genome similarly to
[Nextstrain](https://nextstrain.org). It colors genes to match the Nextstrain
website and displays an "Entropy score" track to show diversity.

<Story of={NextstrainExample} />

### Source

This config uses `FromConfigAdapter`, which takes feature data directly as JSON
rather than from files like GFF3 or BigWig. This is useful for on-the-fly
analyses or when you want to avoid writing data to disk (e.g., a BigWig/GFF3).
