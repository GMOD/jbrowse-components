...
<Story id="source-code-for-examples--with-aggregate-text-searching" />

## Per-track search index

Per-track search indexes contain information for a single track.

<Story id="source-code-for-examples--with-per-track-text-searching" />
...
<Story id="source-with-per-track-text-searching--example" />
