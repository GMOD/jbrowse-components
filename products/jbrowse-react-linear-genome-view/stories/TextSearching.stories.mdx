...
aggregate_meta.json which you can put into your embedded jbrowse config
...
then it will create a myfile.gff3.gz.ix, myfile.gff3.gz.ixx and myfile.gff3.gz_meta.json
