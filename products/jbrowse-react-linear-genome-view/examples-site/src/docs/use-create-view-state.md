...
(`'ctgA:1,000..5,000'`, 1-based) or a `{ refName, start, end }` object (0-based);
the object form is handy when you already have structured coordinates and don't
want to format and reparse a string.
