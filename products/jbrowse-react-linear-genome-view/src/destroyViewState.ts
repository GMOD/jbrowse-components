 ...
 * change, `createLinearGenomeView().destroy()`) otherwise orphans a whole
 * worker pool and a live autorun set per discarded engine. A component that
 * owns one engine for the lifetime of the page never needs this.
 *
