  ...
  return (
    types
      ...
      .actions(self => ({
        ...
        /**
         * #action
         * Called when the Loader releases this root. Stops everything the root
         * runs outside the tree (the worker pool and the autosave autorun) and
         * leaves the tree itself alone.
         *
