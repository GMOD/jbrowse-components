        ...
        <CardHeader
          ...
          title={
            <Tooltip title={name} enterDelay={300}>
              <Typography variant="body2" noWrap className={classes.cardTitle}>
                {name}
              </Typography>
            </Tooltip>
          }
