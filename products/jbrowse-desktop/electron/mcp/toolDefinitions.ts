...
Whatever you "return" comes back serialized (size-capped) with "logs" (console output) and "notifications" (toasts since the last call); a throw names the line in YOUR code. State persists on globalThis.`,
    inputSchema: {
      type: 'object',
      properties: {
        code: {
