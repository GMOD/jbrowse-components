[![Build Status](https://img.shields.io/github/actions/workflow/status/GMOD/jbrowse-components/push.yml?branch=main))](https://github.com/GMOD/jbrowse-components/actions)
