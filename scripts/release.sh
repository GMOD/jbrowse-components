...
trap 'rm -f tmp_changelog.md' EXIT
...
# Generate blog post from the draft, then remove the now-consumed draft so it
# doesn't linger and get mistaken for a pending release
