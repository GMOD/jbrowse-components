...
import { action as action2, computed, reaction, _allowStateChangesInsideComputed } from "mobx";
var nextNodeId = 1;
...
ObjectNode.prototype.createObservableInstance = action2(ObjectNode.prototype.createObservableInstance);
...
var IdentifierCache = /*#__PURE__*/ function() {
    ...
    function _IdentifierCache() {
        ...
        __publicField(this, "cache", observable.map());
        ...
        __publicField(this, "lastCacheModificationPerId", observable.map());
    }
    _create_class(_IdentifierCache, [
        ...
        },
        {
            ...
            value: function splitCache(splitNode) {
                ...
                entries(this.cache).forEach(function(param) {
...
// src/utils.ts
import { isObservableArray, isObservableObject, _getGlobalState, defineProperty as mobxDefineProperty } from "mobx";
...
import { _interceptReads, action as action4, intercept, observable as observable2, ObservableMap, observe, values as values2 } from "mobx";
...
var MSTMap = /*#__PURE__*/ function(ObservableMap) {
    "use strict";
    _inherits(MSTMap, ObservableMap);
    function MSTMap(initialData, name) {
        _class_call_check(this, MSTMap);
        return _call_super(this, MSTMap, [
            initialData,
            observable2.ref.enhancer,
            name
        ]);
    }
...
import { _getAdministration, action as action5, intercept as intercept2, observable as observable3, observe as observe2 } from "mobx";
    ...
    _create_class(_ArrayType, [
        ...
        },
        {
            ...
            value: function createNewInstance(childNodes) {
                ...
                return observable3.array(convertChildNodesToArray(childNodes), options);
            }
        },
        {
            key: "finalizeNewInstance",
...
import { _getAdministration as _getAdministration2, _interceptReads as _interceptReads2, action as action6, computed as computed2, defineProperty as defineProperty2, intercept as intercept3, getAtom, observable as observable4, observe as observe3, set, makeObservable } from "mobx";
    ...
    _create_class(_ModelType, [
        ...
        },
        {
            ...
            value: function instantiateViews(self, views) {
                ...
                Object.getOwnPropertyNames(views).forEach(function(key) {
                    ...
                    if ("get" in descriptor) {
                        defineProperty2(self, key, descriptor);
                        makeObservable(self, _define_property({}, key, computed2));
        ...
        },
        {
            ...
            value: function getChildNode(node, key) {
                ...
                var adm = _getAdministration2(node.storedValue, key);
            ...
            value: function getSubType(mustSucceed) {
                if (!this._subType) {
                    ...
                    try {
                        ...
                        if (_instanceof(e, ReferenceError)) t = void 0;
                        else throw e;
                    }
                    if (mustSucceed && t === void 0) throw fail("Late type seems to be used too early, the definition (still) returns undefined");
                    if (t) {
                        if (devMode() && !isType(t)) throw fail("Failed to determine subtype, make sure types.late returns a type definition.");
                        this._subType = t;
                    }
                }
                return this._subType;
...
var Lazy = /*#__PURE__*/ function(SimpleType2) {
    ...
    function Lazy(name, options) {
        ...
        __publicField(_this, "pendingNodeList", observable5.array());
        when(function() {
            ...
            _this.options.loadType().then(action7(function(type) {
