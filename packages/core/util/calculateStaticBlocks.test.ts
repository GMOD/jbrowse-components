...
test('can calculate some blocks 2', () => {
...
test('can calculate some blocks (should be empty because offscreen to the right)', () => {
...
test('can calculate some blocks (should be empty because offscreen to the left)', () => {
  const blockSet = calculateBlocks({
    bpPerPx: 1,
    width: 800,
    offsetPx: -2000,
...
test('can calculate some blocks 5', () => {
  const blocks = calculateBlocks({
    bpPerPx: 1,
    width: 800,
    offsetPx: 5000,
...
test('can calculate some blocks 6', () => {
  const blockSet = calculateBlocks({
    bpPerPx: 1,
    width: 800,
    offsetPx: 0,
...
test('can calculate some blocks 7', () => {
  const blocks = calculateBlocks({
    bpPerPx: 1,
    width: 800,
    offsetPx: 801,
...
test('can calculate some blocks 8', () => {
  const blocks = calculateBlocks({
    bpPerPx: 1,
    width: 800,
    offsetPx: 1600,
...
test('can calculate some blocks 9', () => {
  const blockSet = calculateBlocks({
    width: 800,
    offsetPx: 1069,
    bpPerPx: 2,
...
test('can calculate some blocks 10', () => {
  const blockSet = calculateBlocks({
    width: 800,
    offsetPx: 0,
    bpPerPx: 0.05,
