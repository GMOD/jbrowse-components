/**
 *vendored from https://github.com/sindresorhus/map-obj as the pure ESM causes trouble
 */
...
export interface TargetOptions<TargetObjectType extends Record<string, any>>
  extends Options {
