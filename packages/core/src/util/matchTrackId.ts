 ...
 * and `-sessionTrack` suffix appended to the original id (see
 * {@link makeTrackId}) — an exact string compare would miss them. Handy for
 * scoping `Core-extraFeaturePanel` / `Core-replaceWidget` callbacks to a track.
 */
