...
export default [
  ...
  '@jbrowse/alignments-core/CoverageTooltipTables',
  '@jbrowse/app-core',
  '@jbrowse/cigar-utils',
  ...
  '@jbrowse/core/pluggableElementTypes/models/HighlightsMixin',
  ...
  '@jbrowse/core/util/adapterConfigKey',
  ...
  '@jbrowse/display-kit/rpcPropsCacheKey',
  ...
  '@jbrowse/plugin-canvas/LinearBasicDisplay/baseStateModel',
  '@jbrowse/plugin-canvas/LinearBasicDisplay/stateModel',
  ...
  '@jbrowse/text-indexing/util',
  '@jbrowse/tree-sidebar',
