...
export default [
  ...
  '@jbrowse/core/util/cssColorParse',
  ...
  '@jbrowse/core/util/lazyWithPreload',
  ...
  '@jbrowse/display-kit/TriangleMatrixMixin',
  '@jbrowse/display-kit/TriangleMatrixSvgLayer',
  ...
  '@jbrowse/render-core/marks/ellipseDistance',
  ...
  '@jbrowse/render-core/shaders/curveDistance',
