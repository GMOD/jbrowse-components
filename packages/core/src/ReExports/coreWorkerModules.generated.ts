...
import * as m126 from '../util/analytics.ts'
import * as m127 from '../util/animationAllowed.ts'
...
const libs: Record<string, unknown> = {
  ...
  '@jbrowse/core/util/analytics': m126,
  '@jbrowse/core/util/animationAllowed': m127,
