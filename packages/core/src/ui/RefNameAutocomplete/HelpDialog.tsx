    ...
    >
      ...
      <ul>
        ...
        <li>
          ...
          as: <code>ref:start..end</code> or <code>ref:start-end</code>. Commas
      ...
      <ul>
        ...
        <li>
          <code>chr1:1-100 chr2:1-100</code> - create a split view of chr1:1-100
          and chr2:1-100
        </li>
        <li>
        ...
        <li>
          <code>chr1:1-100[rev] chr2:1-100</code> - open up the first region in
