...
const BaseViewModel = types
  ...
  .actions(self => ({
     ...
     * it often indicates when the app can start drawing to it.
     *
     * certain views like lgv are strict about this because if it tries to draw
     * before it knows the width it should draw to, it may start fetching data
     * for regions it doesn't need to
     *
