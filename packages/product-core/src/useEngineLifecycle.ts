...
/**
 * Async `useCreateOnce` + `useDestroyOnUnmount`: undefined until the engine is
 * ready. An engine resolving after the final unmount is destroyed on arrival
 * instead of orphaning its worker pool and autoruns.
 */
