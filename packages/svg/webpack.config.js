...
var path = require('path'); // style files regexes


var cssRegex = /\.css$/;
var sassRegex = /\.(scss|sass)$/; // common function to get style loaders, stolen from create-react-app
  ...
  var loaders = [require.resolve('style-loader'), {
    ...
    options: {
      ...
      plugins: function plugins() {
        ...
        require('postcss-flexbugs-fixes'), // eslint-disable-next-line import/no-extraneous-dependencies
