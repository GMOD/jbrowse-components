...
// by the linear displays, the circular ribbons, the tooltip jexl function, the
// launch dialog and the synteny RPC — each of them used to keep its own copy of
// this interface plus its own cast, which is exactly how the shapes drift apart.
...
// non-synteny adapter under an LGVSyntenyDisplay produces, and every caller
