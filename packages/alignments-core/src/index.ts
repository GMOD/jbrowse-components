...
// have to read the shader's own answer rather than restate it —
// `normalizeDepthScalar` against `makeScoreNormalizer` and
// `computeCoverageTicks`, the placement against a recorded `fillRect`.
export {
  covBarHeightPx,
  covSegTopPx,
