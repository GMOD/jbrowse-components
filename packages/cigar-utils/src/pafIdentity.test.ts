import { pafIdentity } from './pafIdentity.ts'
...
describe('pafIdentity', () => {
  ...
  test('reads string tag values, as a PAF line yields them', () => {
    expect(pafIdentity({ de: '0.1', numMatches: '1', blockLen: '2' })).toBe(0.9)
  })
})
