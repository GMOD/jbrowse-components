...
// annotation regardless of whether they sample textures, and
// `assertRenderBindingShape` is what checks that rather than promising it.
//
// The layouts themselves are built once per device in `hal/deviceGpuCache.ts`;
// a bind GROUP is per-HAL, because it names that HAL's uniform ring buffer.
 ...
 * @param layout - `DeviceLayouts.uniformOnlyBindGroupLayout`.
